...
import { Cv as createAllowlistProviderGroupPolicyWarningCollector, Nv as projectConfigAccountIdWarningCollector, P_ as stripChannelTargetPrefix, R_ as adaptScopedAccountAccessor, __ as formatAllowFromLowercase, j_ as createChatChannelPlugin, k_ as buildChannelOutboundSessionRoute, z_ as createHybridChannelConfigAdapter } from "./pi-embedded-D3aYWCrT.js";
...
import { _ as feishuSetupAdapter, a as feishuSetupWizard, c as createFeishuClient, f as listEnabledFeishuAccounts, g as resolveFeishuCredentials, h as resolveFeishuAccount, i as parseFeishuConversationId, m as resolveDefaultFeishuAccountId, p as listFeishuAccountIds } from "./feishu-BP61PzME.js";
import { i as normalizeFeishuTarget, r as looksLikeFeishuId, t as getFeishuRuntime } from "./runtime-bjDYSJfp.js";
import { n as listFeishuDirectoryPeers, t as listFeishuDirectoryGroups } from "./directory.static-B22gCN_Q.js";
import { i as resolveFeishuGroupToolPolicy } from "./policy-hT4bli6h.js";
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-CnhIOzB7.js"), "feishuChannelRuntime");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-BnhHDpHU.js");
			const account = resolveFeishuAccount({
				cfg: ctx.cfg,
