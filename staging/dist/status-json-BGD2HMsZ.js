...
import { h as resolveUpdateChannelDisplay, p as normalizeUpdateChannel } from "./update-check-Bk7xpSh4.js";
import "./node-service-BL9X_sjR.js";
import { r as getUpdateCheckResult } from "./status.update-CA8t8tkL.js";
...
function loadCommandSecretTargetsModule() {
	commandSecretTargetsModulePromise ??= import("./command-secret-targets-CkYMVq-1.js");
	return commandSecretTargetsModulePromise;
}
function loadCommandSecretGatewayModule() {
	commandSecretGatewayModulePromise ??= import("./command-secret-gateway-CkdNu7ZT.js");
