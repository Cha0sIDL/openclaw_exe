...
import { Ar as resolveModelRefFromString, B as loadConfig, Cr as normalizeProviderId, Dr as resolveConfiguredModelRef, Li as DEFAULT_MODEL, Or as resolveDefaultModelForAgent, Qn as upsertAuthProfile, Ri as DEFAULT_PROVIDER, Si as shouldEnableShellEnvFallback, Yn as listProfilesForProvider, Zn as setAuthProfileOrder, _i as resolveEnvApiKey, br as modelKey, cr as resolveOpenClawAgentDir, gi as resolveAwsSdkEnvVarName, gr as findNormalizedProviderValue, hi as resolveApiKeyForProvider, hr as buildModelAliasIndex, l as resolveProfileUnusableUntilForDisplay, mt as parseDurationMs, n as resolveAuthProfileEligibility, pi as getCustomProviderApiKey, r as resolveAuthProfileOrder, sr as resolveAuthStorePathForDisplay, tr as ensureAuthProfileStore, wr as parseModelRef, y as resolveSecretRefString, yi as getShellEnvAppliedKeys, zi as resolveAuthProfileDisplayLabel } from "./auth-profiles-Ok_29lfs.js";
import { t as formatCliCommand } from "./command-format-BTnLVWI8.js";
import { A as resolveDefaultAgentWorkspaceDir, M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, P as toAgentModelListLike, a as resolveAgentDir, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, s as resolveAgentExplicitModelPrimary, u as resolveAgentWorkspaceDir } from "./agent-scope-Ct4K9XNr.js";
...
import { Gt as maskApiKey, Jr as resolveModelWithRegistry, Jt as formatRemainingShort, Kt as DEFAULT_OAUTH_WARN_MS, fn as formatUsageWindowSummary, pn as resolveUsageProviderId, qt as buildAuthHealthSummary, un as loadProviderUsageSummary, ur as runEmbeddedPiAgent, wr as describeFailoverError } from "./compact-BjaPuUSI.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-v4IEHC8Z.js";
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-E64m60XY.js";
import { t as ensureOpenClawModelsJson } from "./models-config-B3eI7jzL.js";
import { n as loadModelCatalog } from "./model-catalog-H8j7NulN.js";
import { i as getModelsCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-Hw0LPI1L.js";
import { f as openUrl } from "./onboard-helpers-0WTf7rCZ.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-DMpJWKki.js";
import { r as withProgressTotals } from "./progress-iK4ygO8h.js";
import { t as createClackPrompter } from "./clack-prompter-CPKGQ_7X.js";
...
import { a as formatMs, c as loadValidConfigOrThrow, d as resolveKnownAgentId, f as resolveModelKeysFromEntries, i as ensureFlagCompatibility, l as mergePrimaryFallbackConfig, m as updateConfig, n as applyOpenAICodexModelDefault, o as formatTokenK, p as resolveModelTarget, r as applyDefaultModelPrimaryUpdate, s as isLocalBaseUrl, t as OPENAI_CODEX_DEFAULT_MODEL, u as normalizeAlias } from "./openai-codex-model-default-CL572JEJ.js";
import { Ct as writeOAuthCredentials, d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-NvylbLP_.js";
import { n as logConfigUpdated } from "./logging-CQxJ5H3_.js";
import { a as loginOpenAICodexOAuth, c as resolvePluginProviders, i as resolveProviderMatch, n as mergeConfigPatch, o as createVpsAwareOAuthHandlers, r as pickAuthMethod, s as isRemoteEnvironment, t as applyDefaultModel } from "./provider-auth-helpers-Di4sE1tq.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles-Ok_29lfs.js").then((n) => n.t);
	const cfg = await loadModelsConfig({
