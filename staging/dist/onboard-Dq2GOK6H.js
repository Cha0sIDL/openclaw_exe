...
import { G as writeConfigFile, V as readConfigFileSnapshot, ct as resolveDefaultSecretProviderAlias } from "./auth-profiles-tPxLL4Q6.js";
import { t as formatCliCommand } from "./command-format-CLEQe4bk.js";
import { v as resolveUserPath } from "./utils-cwpAMi-t.js";
import { N as isValidEnvSecretRefId } from "./registry-p3miLKfM.js";
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-Cl_losjk.js";
import { t as WizardCancelledError } from "./prompts-GoDC3iAV.js";
import { t as createClackPrompter } from "./clack-prompter-QUMfxj2-.js";
import { t as assertSupportedRuntime } from "./runtime-guard-BMUPc-7K.js";
...
import { i as normalizeLegacyOnboardAuthChoice, r as isDeprecatedAuthChoice, t as ONBOARD_PROVIDER_AUTH_FLAGS } from "./onboard-provider-auth-flags-Bw33jo_g.js";
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-oUKoFfFB.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-DVrF9afq.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-YXMbQIOr.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-84CrPUUO.js").then((n) => n.i);
