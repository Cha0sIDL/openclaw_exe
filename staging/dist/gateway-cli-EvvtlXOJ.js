...
import { C as clearInternalHooks, E as triggerInternalHook, T as registerInternalHook, h as createEmptyPluginRegistry, j as hasConfiguredSecretInput, t as CHANNEL_IDS, u as getActivePluginRegistry, w as createInternalHookEvent } from "./registry-p3miLKfM.js";
import "./github-copilot-token-Byc_YVYE.js";
import { u as isTestDefaultMemorySlotDisabled } from "./manifest-registry-Dmh8Lc7n.js";
...
import { $t as hasLegacyDeliveryHints, A as handleSlackHttpRequest, Ar as getTtsProvider, B as createOutboundSendDeps, Br as textToSpeech, C as loadOpenClawPlugins, Cn as markGatewaySigusr1RestartHandled, Cr as resolveAgentIdentity, Ct as ensureOutboundSessionEntry, Dn as triggerOpenClawRestart, Dr as resolveUserTimezone, Dt as resolveOutboundTarget, En as setPreRestartDeferralCheck, Fr as resolveTtsConfig, Ft as consumeRestartSentinel, G as resolveAgentAvatar, Gn as enqueueSystemEvent, Gt as inferLegacyName, H as createOutboundSendDeps$1, Hr as OPENAI_TTS_VOICES, Ht as normalizeHttpWebhookUrl, I as agentCommandFromIngress, Ir as resolveTtsPrefsPath, It as formatDoctorNonInteractiveHint, Jr as resetAllLanes, Jt as normalizeOptionalText, Kn as isSystemEventContextChanged, Kr as getTotalQueueSize, Kt as normalizeOptionalAgentId, Ln as resolveBootstrapWarningSignaturesSeen, Lr as resolveTtsProviderOrder, Lt as formatRestartSentinelMessage, M as requestBodyErrorToText, Mr as isTtsProviderConfigured, Nr as resolveTtsApiKey, Nt as runWithModelFallback, O as resolveAgentOutboundIdentity, On as unbindThreadBindingsBySessionKey, Ot as resolveSessionDeliveryTarget, Pr as resolveTtsAutoMode, Qr as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, Qt as buildDeliveryFromLegacyPayload, R as resolveAgentDeliveryPlan, Rn as formatZonedTimestamp, Rr as setTtsEnabled, Sn as isGatewaySigusr1RestartExternallyAllowed, Sr as resolveAgentSessionDirs, Tn as setGatewaySigusr1RestartPolicy, Ut as normalizeCronJobCreate, V as createDefaultDeps, Vr as OPENAI_TTS_MODELS, Vt as writeRestartSentinel, Wr as getActiveTaskCount, Wt as normalizeCronJobPatch, Xr as waitForActiveTasks, Xt as normalizeRequiredName, Y as createReplyPrefixOptions, Yn as requestHeartbeatNow, Yr as setCommandLaneConcurrency, Yt as normalizePayloadToSystemText, Z as buildHistoryContextFromEntries, Zr as CommandLane, Zt as migrateLegacyCronPayload, _ as applyToolPolicyPipeline, _n as parseVerboseOverride, _r as isAbortRequestText, _t as setCliSessionId, ai as getAgentRunContext, an as getHookType, ar as DEFAULT_INPUT_MAX_REDIRECTS, b as getPluginToolMeta, bn as deferGatewayRestartUntilIdle, bt as readLatestAssistantReply, cn as applyBrowserProxyPaths, cr as extractImageContentFromSource, ct as dispatchInboundMessage, d as runSubagentAnnounceFlow, en as stripLegacyDeliveryFields, er as ACP_SESSION_IDENTITY_RENDERER_VERSION, f as clearSessionQueues, fr as resolveAgentTimeoutMs, g as waitForEmbeddedPiRunEnd, gn as applyVerboseOverride, gt as getCliSessionId, h as getActiveEmbeddedRunCount, hn as applyModelOverrideToSessionEntry, ht as resolveCronStyleNow, i as initSubagentRegistry, ii as emitAgentEvent, in as detectSuspiciousPatterns, ir as DEFAULT_INPUT_IMAGE_MIMES, j as readJsonBodyWithLimit, jn as loadProviderUsageSummary, jr as isTtsEnabled, jt as resetDirectoryCache, kn as normalizeGroupActivation, kr as clearBootstrapSnapshot, kt as resolveOutboundChannelPlugin, ln as persistBrowserProxyFiles, lr as normalizeMimeList, lt as createReplyDispatcher, m as abortEmbeddedPiRun, mr as resolveSendPolicy, ni as stripHeartbeatToken, o as listDescendantRunsForRequester, oi as onAgentEvent, on as isExternalHookSession, or as DEFAULT_INPUT_TIMEOUT_MS, p as runEmbeddedPiAgent, pr as normalizeSendPolicy, pt as buildBareSessionResetPrompt, qr as markGatewayDraining, qt as normalizeOptionalSessionKey, ri as clearAgentRunContext, rn as buildSafeExternalPrompt, rr as DEFAULT_INPUT_IMAGE_MAX_BYTES, si as registerAgentRunContext, sn as closeTrackedBrowserTabsForSessions, sr as extractFileContentFromSource, t as countActiveDescendantRuns, un as resolveSessionAuthProfileOverride, ur as resolveInputFileLimits, ut as getTotalPendingReplies, v as buildDefaultToolPolicyPipelineSteps, vn as buildOutboundSessionContext, vr as stopSubagentsForRequester, vt as runCliAgent, w as createPluginRuntime, wn as scheduleGatewaySigusr1Restart, wt as resolveOutboundSessionRoute, x as resolvePluginTools, xn as emitGatewayRestart, xr as getAcpSessionManager, xt as resolveAnnounceTargetFromKey, yn as consumeGatewaySigusr1RestartAuthorization, yt as createOpenClawTools, z as resolveAgentOutboundTarget, zr as setTtsProvider, zt as summarizeRestartSentinel } from "./subagent-registry-DHXuwfxh.js";
import { c as resolveStorePath, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveSessionTranscriptsDirForAgent } from "./paths-cmEiiwMK.js";
import { i as normalizeInputProvenance } from "./input-provenance-uI0s4A95.js";
import "./chat-envelope-n7RmUTHV.js";
import { n as readJsonFile, r as writeJsonAtomic, t as createAsyncLock } from "./json-files-CcpjHx-d.js";
import { $ as validateNodePairApproveParams, $t as updatePairedDeviceMetadata, A as validateCronRunParams, At as validateWizardCancelParams, B as validateExecApprovalRequestParams, Bt as buildDeviceAuthPayloadV3, C as validateConfigSchemaLookupResult, Ct as validateTalkConfigParams, D as validateCronAddParams, Dt as validateWakeParams, E as validateConnectParams, Et as validateUpdateRunParams, F as validateDevicePairListParams, Ft as ErrorCodes, G as validateExecApprovalsSetParams, Gt as getPairedDevice, H as validateExecApprovalsGetParams, I as validateDevicePairRejectParams, It as errorShape, J as validateNodeDescribeParams, Jt as removePairedDevice, K as validateLogsTailParams, Kt as listDevicePairing, L as validateDevicePairRemoveParams, M as validateCronStatusParams, Mt as validateWizardStartParams, N as validateCronUpdateParams, Nt as validateWizardStatusParams, O as validateCronListParams, Ot as validateWebLoginStartParams, P as validateDevicePairApproveParams, Pt as PROTOCOL_VERSION, Q as validateNodeListParams, Qt as summarizeDeviceTokens, R as validateDeviceTokenRevokeParams, Rt as parseSessionLabel, S as validateConfigSchemaLookupParams, St as validateSkillsUpdateParams, T as validateConfigSetParams, Tt as validateToolsCatalogParams, U as validateExecApprovalsNodeGetParams, Ut as approveDevicePairing, V as validateExecApprovalResolveParams, Vt as normalizeDeviceMetadataForAuth, W as validateExecApprovalsNodeSetParams, Wt as ensureDeviceToken, X as validateNodeInvokeParams, Xt as revokeDeviceToken, Y as validateNodeEventParams, Yt as requestDevicePairing, Z as validateNodeInvokeResultParams, Zt as rotateDeviceToken, _ as validateChatInjectParams, _t as validateSessionsResolveParams, a as validateAgentWaitParams, an as normalizeDevicePublicKeyBase64Url, at as validatePollParams, b as validateConfigGetParams, bt as validateSkillsInstallParams, c as validateAgentsFilesGetParams, ct as validateSecretsResolveParams, d as validateAgentsListParams, dt as validateSessionsCompactParams, en as verifyDeviceToken, et as validateNodePairListParams, f as validateAgentsUpdateParams, ft as validateSessionsDeleteParams, g as validateChatHistoryParams, gt as validateSessionsResetParams, h as validateChatAbortParams, ht as validateSessionsPreviewParams, i as validateAgentParams, it as validateNodeRenameParams, j as validateCronRunsParams, jt as validateWizardNextParams, k as validateCronRemoveParams, kt as validateWebLoginWaitParams, l as validateAgentsFilesListParams, lt as validateSecretsResolveResult, m as validateChannelsStatusParams, mt as validateSessionsPatchParams, n as formatValidationErrors, nt as validateNodePairRequestParams, o as validateAgentsCreateParams, on as verifyDeviceSignature, ot as validatePushTestParams, p as validateChannelsLogoutParams, pt as validateSessionsListParams, q as validateModelsListParams, qt as rejectDevicePairing, r as validateAgentIdentityParams, rn as deriveDeviceIdFromPublicKey, rt as validateNodePairVerifyParams, s as validateAgentsDeleteParams, st as validateRequestFrame, tn as roleScopesAllow, tt as validateNodePairRejectParams, u as validateAgentsFilesSetParams, ut as validateSendParams, v as validateChatSendParams, vt as validateSessionsUsageParams, w as validateConfigSchemaParams, wt as validateTalkModeParams, x as validateConfigPatchParams, xt as validateSkillsStatusParams, y as validateConfigApplyParams, yt as validateSkillsBinsParams, z as validateDeviceTokenRotateParams, zt as buildDeviceAuthPayload } from "./client-CzImpHGe.js";
import { c as ADMIN_SCOPE$3, d as isNodeRoleMethod, n as callGateway, p as loadGatewayTlsRuntime$1, u as authorizeOperatorScopesForMethod } from "./call-MMA9uqcd.js";
import "./pairing-token-h5vg0oaO.js";
import { t as safeEqualSecret } from "./secret-equal-BN0idTaZ.js";
import { a as isTrustedProxyAddress, c as pickPrimaryLanIPv4, d as resolveGatewayListenHosts, f as rawDataToString, l as resolveClientIp, n as isLoopbackAddress, o as isValidIPv4, r as isLoopbackHost, s as normalizeHostHeader, t as isLocalishHost, u as resolveGatewayBindHost } from "./net-0Fapzizl.js";
import { n as pickPrimaryTailnetIPv4, r as pickPrimaryTailnetIPv6 } from "./tailnet-cWmPZlFU.js";
import { a as getMachineDisplayName, i as startBrowserControlServiceFromConfig, n as createBrowserRouteDispatcher, r as createBrowserControlContext } from "./with-timeout-Df9sBesu.js";
import { j as runGlobalGatewayStopSafely, k as getGlobalHookRunner, o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads } from "./deliver-9DUxhD0K.js";
import { c as detectMime } from "./image-ops--7j2A6VZ.js";
import { b as resolveCronStorePath, x as saveCronStore, y as loadCronStore } from "./send-iadNcshI.js";
import "./pi-embedded-helpers-BZ9Btdtj.js";
import { C as resolveToolProfilePolicy, _ as collectExplicitAllowlist, y as mergeAlsoAllowPolicy } from "./sandbox-B1Nlj37O.js";
...
import { i as enableTailscaleServe, n as disableTailscaleServe, o as getTailnetHostname, r as enableTailscaleFunnel, t as disableTailscaleFunnel } from "./tailscale-Bx7OP_Ql.js";
import { a as resolveGatewayAuth, c as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, i as isLocalDirectRequest, l as createAuthRateLimiter, n as authorizeHttpGatewayConnect, o as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, r as authorizeWsControlUiGatewayConnect, s as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH, t as assertGatewayAuthConfigured, u as normalizeRateLimitClientIp } from "./auth-BothAgrh.js";
import { d as mergeGatewayTailscaleConfig, l as ensureGatewayStartupAuth, u as mergeGatewayAuthConfig } from "./server-context-BeIaDzE3.js";
import "./paths-DkGd1YEC.js";
import { a as testRegexWithBoundedInput, i as compileSafeRegex } from "./redact-LmGH4yE3.js";
import { o as isErrno, r as formatErrorMessage } from "./errors-s25Xfb--.js";
import { i as openFileWithinRoot, l as writeFileWithinRoot, s as readLocalFileSafely, t as SafeOpenError } from "./fs-safe-z-Hw12Xy.js";
import { n as SsrFBlockedError } from "./proxy-env-DxO4ZKbR.js";
import "./store-CtS8gb_5.js";
import { n as inspectPortUsage, o as formatPortDiagnostics, t as ensurePortAvailable } from "./ports-GoOZaxy6.js";
import { t as movePathToTrash } from "./trash-uRrkiV94.js";
import "./server-middleware-CJxtwXCE.js";
import { o as estimateBase64DecodedBytes } from "./tool-images-BRNSPwBR.js";
...
import { n as loadModelCatalog } from "./model-catalog-Dk_yJRXt.js";
import "./fetch-D7b6wfSg.js";
import { g as registerUnhandledRejectionHandler } from "./audio-transcription-runner-BxtTIEX5.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-De5_S5uz.js";
import { b as extractTextFromChatContent } from "./image-DtEfXBAZ.js";
...
import { a as ToolInputError } from "./target-errors-DoRHR088.js";
import { r as isRestartEnabled } from "./commands-CUiU_v7O.js";
import "./commands-registry-BeCEsRcX.js";
import "./fetch-CtpgORyl.js";
import { a as readChannelAllowFromStoreSync } from "./pairing-store-C1ToH9-1.js";
...
import { _ as matchSystemRunApprovalBinding, g as buildSystemRunApprovalBinding, h as resolveSystemRunApprovalRuntimeContext, m as resolveSystemRunApprovalRequestContext, v as missingSystemRunApprovalBinding, y as toSystemRunApprovalMismatchError } from "./nodes-screen-DoZC45cv.js";
import { n as resolveSystemRunCommand } from "./system-run-command-vdIqIAMV.js";
...
import { c as hasNonzeroUsage, i as loadSessionUsageTimeSeries, n as loadCostUsageSummary, r as loadSessionCostSummary, s as deriveSessionTotalTokens, t as discoverAllSessions } from "./session-cost-usage-Cuy-C8Lt.js";
import { n as formatTokenCount, r as formatUsd } from "./usage-format-DmCdWNdr.js";
import { _ as updatePairedNodeMetadata, a as getRemoteSkillEligibility, b as getSkillsSnapshotVersion, c as refreshRemoteBinsForConnectedNodes, d as setSkillsRemoteRegistry, f as approveNodePairing, g as requestNodePairing, h as renamePairedNode, l as refreshRemoteNodeBins, m as rejectNodePairing, o as primeRemoteSkillsCache, p as listNodePairing, s as recordRemoteNodeInfo, u as removeRemoteNodeInfo, v as verifyNodeToken, x as registerSkillsChangeListener } from "./skill-commands-CBob5fWP.js";
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy } from "./pi-tools.policy-DlBcQzB9.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-BxOxr-Al.js";
import { t as getChannelActivity } from "./channel-activity-DfkC2Ool.js";
import { n as normalizePollInput } from "./polls-BzvxJZsC.js";
import "./tables-BVQfA5JD.js";
import "./server-lifecycle-BUL_-s1-.js";
import { i as parseAbsoluteTimeMs, n as resolveCronStaggerMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-BEp9o7MA.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-BGEIUAHe.js";
import { i as buildChannelUiCatalog, t as applyPluginAutoEnable } from "./plugin-auto-enable-CP5qYGgR.js";
...
import { n as GATEWAY_AUTH_SURFACE_PATHS, p as isKnownSecretTargetId, r as evaluateGatewayAuthSurfaceStates } from "./runtime-config-collectors-Cwq4_1iU.js";
import "./command-secret-targets-DCqd4iaR.js";
import { C as normalizeControlUiBasePath, S as buildControlUiAvatarUrl, c as handleReset, w as resolveAssistantAvatarUrl, x as CONTROL_UI_AVATAR_PREFIX } from "./onboard-helpers-Cl_losjk.js";
import "./prompt-style-By2UMb-r.js";
import "./pairing-labels-5oVgx8lC.js";
import { i as resolveMemoryBackendConfig, r as getMemorySearchManager } from "./memory-cli-BnqyPcv5.js";
import { i as resolveMemorySearchConfig } from "./manager-Wkc4zq7t.js";
...
import { t as formatHelpExamples } from "./help-format-BfsJc6rE.js";
import { n as withProgress } from "./progress-5B42_wGt.js";
...
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-D4od4frO.js";
import { t as isWithinDir } from "./path-safety-VqrwbBfj.js";
import "./install-safe-path-C1cub9eT.js";
import "./skill-scanner-BVCwsdIZ.js";
import { n as formatConfigIssueLines } from "./issue-format-DFox5Yka.js";
import { t as buildChannelAccountSnapshot } from "./status-CiZyKdUg.js";
import "./channels-status-issues-CknXhw9E.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-BukHiisx.js";
...
import "./lifecycle-core-57LTU3aW.js";
import "./systemd-hints-HPAJgK9j.js";
import { t as parsePort$1 } from "./parse-port-CboE2EQm.js";
import { n as addGatewayServiceCommands } from "./daemon-cli-U4Nas6S7.js";
import { t as probeGateway } from "./probe-oK0gM9P8.js";
import "./diagnostics-BeD8xHCT.js";
...
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-DE22ocZM.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-C8iwiP53.js";
import { t as resolveConfiguredSecretInputString } from "./resolve-configured-secret-input-string-B4sZ8SaF.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-Co_KO1mG.js";
import { a as styleHealthChannelLine, c as setHeartbeatsEnabled, l as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines, u as isCronSystemEvent } from "./health-84CrPUUO.js";
import { a as resolveControlUiRootSync, i as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-DwBFn-HC.js";
import { h as normalizeUpdateChannel, l as DEFAULT_PACKAGE_CHANNEL, n as checkUpdateStatus, o as resolveNpmChannelTag, r as compareSemverStrings } from "./channel-account-context-B86cc9a5.js";
import { a as resolveCommandSecretsFromActiveRuntimeSnapshot, i as prepareSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, r as getActiveSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-DTOuGsos.js";
import "./onboarding.secret-input-izFJWWcE.js";
import { t as runOnboardingWizard } from "./onboarding-CFZiX9Li.js";
import { a as sendApnsAlert, c as parseMessageWithAttachments, d as shouldLogWs, f as summarizeAgentEventForWsLog, i as resolveApnsAuthConfigFromEnv, l as formatForLog, n as normalizeApnsEnvironment, o as sendApnsBackgroundWake, p as setGatewayWsLogStyle, s as normalizeRpcAttachmentsToChatAttachments, t as loadApnsRegistration, u as logWs } from "./push-apns-DO0pf3-y.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-DxNAu0zk.js";
import { n as isNodeCommandAllowed, r as resolveNodeCommandAllowlist } from "./node-command-policy-a0mznNVY.js";
import { n as collectEnabledInsecureOrDangerousFlags } from "./audit-2U3cUuQe.js";
import "./node-service-Cd5FtN40.js";
import "./status.update-ZHxpOEXH.js";
import { t as installSkill } from "./skills-install-ylPPhpZG.js";
import { t as runGatewayUpdate } from "./update-runner-D_H4QIAO.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-3S4oK3z8.js";
import { n as forceFreePortAndWait, r as waitForPortBindable } from "./ports-D9Jh8N8D.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-DygAMhdB.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-Cuy-C8Lt.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-BOTiF13q.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-DRfXGeMj.js").then((n) => n.n);
		const { deliverOutboundPayloads } = await import("./deliver-9DUxhD0K.js").then((n) => n.n);
