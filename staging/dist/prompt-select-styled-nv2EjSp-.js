...
import { d as resolveProfileUnusableUntilForDisplay, h as repairOAuthProfileIdMismatch, m as resolveApiKeyForProfile } from "./auth-profiles-CERaUUqX.js";
...
import { Cf as resolveBootstrapContextForRun, Cy as resolveBootstrapMaxChars, Df as buildBootstrapInjectionStats, Ef as analyzeBootstrapBudget, Eh as listTelegramAccountIds, M as hasConfiguredMemorySecretInput, ag as applyPluginAutoEnable, ft as resolvePluginProviders, kh as resolveTelegramAccount, ky as loadModelCatalog, pt as loadOpenClawPlugins, pu as resolveCommandSecretRefsViaGateway, wh as inspectTelegramAccount, wy as resolveBootstrapTotalMaxChars, xh as lookupTelegramChatId, z as resolveApiKeyForProvider } from "./pi-embedded-D3aYWCrT.js";
...
import { C as parseBrowserMajorVersion, T as resolveGoogleChromeExecutableForPlatform, at as resolveConfiguredSecretInputWithFallback, w as readBrowserVersion } from "./routes-BbrNKa8i.js";
...
import { a as listInterpreterLikeSafeBins, s as resolveMergedSafeBinProfileFixtures } from "./exec-inline-eval-D-f8HFse.js";
import { n as getChannelsCommandSecretTargetIds } from "./command-secret-targets-C0ZVtvSJ.js";
import { r as resolveMemoryBackendConfig } from "./search-manager-ln9SNtGS.js";
import { a as detectLegacyMatrixState, i as autoMigrateLegacyMatrixState, n as hasPendingMatrixMigration, o as autoPrepareLegacyMatrixCrypto, r as maybeCreateMatrixMigrationSnapshot, s as detectLegacyMatrixCrypto, t as hasActionableMatrixMigration } from "./matrix-migration-snapshot-xDu_uNMQ.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-DA97nLIK.js";
import { r as buildPluginCompatibilityWarnings } from "./status-BgQxL4xd.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-CGpbt8E5.js";
import { t as note$1 } from "./note-B4_hCiCT.js";
import { r as healthCommand } from "./health-BVVCVIR8.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-Bi73BkeP.js";
import { m as normalizeStoredCronJobs, n as runGatewayUpdate, t as runStartupMatrixMigration, v as detectPluginInstallPathIssue, y as formatPluginInstallPathIssue } from "./server-startup-matrix-migration-QoGK97Fp.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-DMP_qm2e.js";
import { n as resolveProviderAuthLoginCommand, t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-CZBj8hy8.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-CB3t-7JW.js";
import { t as formatHealthCheckFailure } from "./health-format-0Xx42hRW.js";
import { n as doctorShellCompletion } from "./doctor-completion-DOmfVm_t.js";
import { a as stripUnknownConfigKeys, i as resolveConfigPathTarget, n as formatConfigPath, r as noteOpencodeProviderOverrides, t as runDoctorConfigPreflight } from "./doctor-config-preflight-Kmno0-u3.js";
import { a as isMattermostMutableAllowEntry, i as isMSTeamsMutableAllowEntry, n as isGoogleChatMutableAllowEntry, o as isSlackMutableAllowEntry, r as isIrcMutableAllowEntry, s as isZalouserMutableGroupEntry, t as isDiscordMutableAllowEntry } from "./mutable-allowlist-detectors-BleuVwGY.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-B5ejviEp.js";
import { i as runLegacyStateMigrations, n as detectLegacyStateMigrations } from "./doctor-state-migrations-NNpALgpS.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./provider-openai-codex-oauth-tls-BPIAPSwU.js";
