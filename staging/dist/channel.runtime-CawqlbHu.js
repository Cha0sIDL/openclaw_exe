...
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-DdeQ84id.js";
import { t as sendMessageZalo } from "./send-D2hqoksh.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-Bo7y-wcO.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-BoRSF0Ef.js");
