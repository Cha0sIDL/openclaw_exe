...
import { Br as resolveModelWithRegistry, Ft as formatUsageWindowSummary, It as resolveUsageProviderId, Nt as loadProviderUsageSummary, a as buildAuthHealthSummary, cn as describeFailoverError, i as DEFAULT_OAUTH_WARN_MS, o as formatRemainingShort, r as maskApiKey, w as runEmbeddedPiAgent } from "./reply-D6-YfhOC.js";
...
import { t as ensureOpenClawModelsJson } from "./models-config-DzMwP8CW.js";
...
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-C_Kd9gsY.js";
...
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-BELV3Nh9.js";
...
import { i as getModelsCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-4tvPNNBM.js";
import "./session-cost-usage-CIwOfDOX.js";
import { f as openUrl } from "./onboard-helpers-KqKFzq9h.js";
...
import { n as runCommandWithRuntime, t as resolveOptionFromCommand } from "./cli-utils-CwhfeUyk.js";
import "./help-format-DQVSSJgX.js";
import { r as withProgressTotals } from "./progress-DJwvk8T-.js";
...
import { a as formatMs, c as loadValidConfigOrThrow, d as resolveKnownAgentId, f as resolveModelKeysFromEntries, i as ensureFlagCompatibility, l as mergePrimaryFallbackConfig, m as updateConfig, n as applyOpenAICodexModelDefault, o as formatTokenK, p as resolveModelTarget, r as applyDefaultModelPrimaryUpdate, s as isLocalBaseUrl, t as OPENAI_CODEX_DEFAULT_MODEL, u as normalizeAlias } from "./openai-codex-model-default-CEfP3N1r.js";
import { Ct as writeOAuthCredentials, d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-BBYT2sjx.js";
import { n as logConfigUpdated } from "./logging-C9DZ91kl.js";
import { a as loginOpenAICodexOAuth, c as resolvePluginProviders, i as resolveProviderMatch, l as githubCopilotLoginCommand, n as mergeConfigPatch, o as createVpsAwareOAuthHandlers, r as pickAuthMethod, s as isRemoteEnvironment, t as applyDefaultModel } from "./provider-auth-helpers-BDp4pkru.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./model-selection-D6yIS4i6.js").then((n) => n.ht);
	const cfg = await loadModelsConfig({
