...
import { $r as MAX_INCLUDE_DEPTH, En as normalizeNetworkMode, Gt as inspectPathPermissions, Kt as safeStat, Qr as INCLUDE_KEY, Qt as createConfigIO, Tn as isDangerousNetworkMode, Ut as formatPermissionDetail, Wt as formatPermissionRemediation, fr as normalizeTrustedSafeBinDirs } from "./model-selection-D6yIS4i6.js";
import { j as hasConfiguredSecretInput } from "./registry-D9k2JaF8.js";
import { t as formatCliCommand } from "./command-format-Gp1OUMPH.js";
import { d as normalizePluginsConfig } from "./manifest-registry-CfBuZDUD.js";
import { i as isPathInside, n as MANIFEST_KEY, r as extensionUsesSkippedScannerPath } from "./legacy-names-BYUgjYSw.js";
import { l as normalizeStringEntries } from "./dock-y4QSCOQM.js";
import { n as listChannelPlugins } from "./plugins-DmEd4pqG.js";
import { C as resolveToolProfilePolicy, f as resolveSandboxConfigForAgent, k as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, l as execDockerRaw, m as resolveSandboxToolPolicyForAgent, u as getBlockedBindReason } from "./sandbox-BL9DTDci.js";
import { a as resolveGatewayAuth } from "./auth-BL2Aq1B9.js";
import { n as resolveGatewayCredentialsFromConfig, t as isGatewaySecretRefUnavailableError } from "./credentials--ttUdToo.js";
import { a as resolveProfile, c as resolveBrowserControlAuth, i as resolveBrowserConfig } from "./server-context-D9RxmesE.js";
import { i as loadWorkspaceSkillEntries } from "./skills-CvS3YvgT.js";
import { a as resolveNativeSkillsEnabled, i as resolveNativeCommandsEnabled } from "./commands-BrchMLbc.js";
import { t as buildGatewayConnectionDetails } from "./call-CXalT0Oq.js";
import { r as resolveMergedSafeBinProfileFixtures, t as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-DBZ3wFej.js";
import { i as readChannelAllowFromStore } from "./pairing-store-Cty2495o.js";
import { n as hasConfiguredUnavailableCredentialStatus, o as isToolAllowedByPolicies, p as resolveDmAllowState, r as hasResolvedCredentialValue, t as inspectReadOnlyChannelAccount, u as pickSandboxToolPolicy } from "./read-only-account-inspect-C_MxWrrb.js";
import { n as isDangerousNameMatchingEnabled } from "./dangerous-name-matching-G4MeiW1m.js";
...
import { t as scanDirectoryWithSummary } from "./skill-scanner-D-2H3WNW.js";
import { t as probeGateway } from "./probe-CLeAQ9sz.js";
import { r as resolveNodeCommandAllowlist, t as DEFAULT_DANGEROUS_NODE_COMMANDS } from "./node-command-policy-QewdXe0m.js";
