...
import { $t as normalizeTrustedSafeBinDirs, A as formatPermissionDetail, M as inspectPathPermissions, N as safeStat, ft as isDangerousNetworkMode, j as formatPermissionRemediation, pt as normalizeNetworkMode, z as createConfigIO, zn as INCLUDE_KEY } from "./auth-profiles-Ok_29lfs.js";
import { t as formatCliCommand } from "./command-format-BTnLVWI8.js";
import { M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, d as resolveDefaultAgentId } from "./agent-scope-Ct4K9XNr.js";
...
import { n as isPathInside, t as extensionUsesSkippedScannerPath } from "./scan-paths-4G32Viy3.js";
import { d as normalizePluginsConfig } from "./manifest-registry-CDX-Vxgs.js";
import { n as MANIFEST_KEY } from "./legacy-names-DyWjlWaR.js";
import { l as normalizeStringEntries } from "./dock-D5Ul7srh.js";
import { n as listChannelPlugins } from "./plugins-DH0nf2wM.js";
import { C as resolveToolProfilePolicy, f as resolveSandboxConfigForAgent, k as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, l as execDockerRaw, m as resolveSandboxToolPolicyForAgent, u as getBlockedBindReason } from "./sandbox-B3ZfWqQX.js";
import { a as resolveGatewayAuth } from "./auth-DPbW35vL.js";
import { n as resolveGatewayCredentialsFromConfig, t as isGatewaySecretRefUnavailableError } from "./credentials-BL6xGltc.js";
import { a as resolveProfile, c as resolveBrowserControlAuth, i as resolveBrowserConfig } from "./server-context-BGjLULS5.js";
import { i as loadWorkspaceSkillEntries } from "./skills-UtzuOmV5.js";
import { r as resolveMergedSafeBinProfileFixtures, t as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-D8Ep09V5.js";
import { a as resolveNativeSkillsEnabled, i as resolveNativeCommandsEnabled } from "./commands-BNyCzjzn.js";
import { t as buildGatewayConnectionDetails } from "./call-DVkWjKJC.js";
import { i as readChannelAllowFromStore } from "./pairing-store-Dbq5DTRR.js";
import { _ as hasResolvedCredentialValue, g as hasConfiguredUnavailableCredentialStatus, h as inspectReadOnlyChannelAccount, l as resolveDmAllowState, n as isToolAllowedByPolicies, o as pickSandboxToolPolicy } from "./pi-tools.policy-BIEFeQWi.js";
...
import { t as scanDirectoryWithSummary } from "./skill-scanner-Cmw7Fh0h.js";
import { t as probeGateway } from "./probe-CSOAxNOo.js";
import { r as resolveNodeCommandAllowlist, t as DEFAULT_DANGEROUS_NODE_COMMANDS } from "./node-command-policy-1_dwEWn9.js";
