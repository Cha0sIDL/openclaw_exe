...
import { d as defaultRuntime, f as restoreTerminalState } from "./subsystem-B-oDv-jG.js";
import { Cn as resolveDefaultSecretProviderAlias, nn as readConfigFileSnapshot, on as writeConfigFile } from "./model-selection-Ct4JRMnm.js";
...
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers--etFdTIT.js";
...
import "./daemon-runtime-BSALRrkG.js";
import { t as runOnboardingWizard } from "./onboarding-CDIT68uk.js";
import { n as logConfigUpdated } from "./logging-V0KcnxRn.js";
import { i as normalizeLegacyOnboardAuthChoice, r as isDeprecatedAuthChoice, t as ONBOARD_PROVIDER_AUTH_FLAGS } from "./onboard-provider-auth-flags-Bv1vskpX.js";
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-B7digcR2.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-obL05oDs.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-qJVeBSJF.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-Cpa-yePi.js").then((n) => n.i);
