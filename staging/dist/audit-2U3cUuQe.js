...
import { A as formatPermissionRemediation, M as safeStat, Qt as normalizeTrustedSafeBinDirs, R as createConfigIO, Rn as INCLUDE_KEY, dt as isDangerousNetworkMode, ft as normalizeNetworkMode, j as inspectPathPermissions, k as formatPermissionDetail, zn as MAX_INCLUDE_DEPTH } from "./auth-profiles-tPxLL4Q6.js";
import { t as formatCliCommand } from "./command-format-CLEQe4bk.js";
import { M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, d as resolveDefaultAgentId } from "./agent-scope-BGsA4zEf.js";
import { c as normalizeAgentId } from "./session-key-k6urs9r-.js";
import { j as hasConfiguredSecretInput } from "./registry-p3miLKfM.js";
import { d as normalizePluginsConfig } from "./manifest-registry-Dmh8Lc7n.js";
import { i as isPathInside, n as MANIFEST_KEY, r as extensionUsesSkippedScannerPath } from "./legacy-names-D3aIn6ij.js";
import { l as normalizeStringEntries } from "./dock-TO1HzU4S.js";
import { i as loadWorkspaceSkillEntries } from "./skills-DvBk_SBL.js";
import { n as listChannelPlugins } from "./plugins-hyZRvFwO.js";
import { t as buildGatewayConnectionDetails } from "./call-MMA9uqcd.js";
import { n as resolveGatewayCredentialsFromConfig, t as isGatewaySecretRefUnavailableError } from "./credentials-DaH7G1kR.js";
import { C as resolveToolProfilePolicy, f as resolveSandboxConfigForAgent, k as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, l as execDockerRaw, m as resolveSandboxToolPolicyForAgent, u as getBlockedBindReason } from "./sandbox-B1Nlj37O.js";
import { a as resolveGatewayAuth } from "./auth-BothAgrh.js";
import { a as resolveProfile, c as resolveBrowserControlAuth, i as resolveBrowserConfig } from "./server-context-BeIaDzE3.js";
import { r as resolveMergedSafeBinProfileFixtures, t as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy--zDBCppO.js";
import { a as resolveNativeSkillsEnabled, i as resolveNativeCommandsEnabled } from "./commands-CUiU_v7O.js";
import { i as readChannelAllowFromStore } from "./pairing-store-C1ToH9-1.js";
import { _ as hasResolvedCredentialValue, g as hasConfiguredUnavailableCredentialStatus, h as inspectReadOnlyChannelAccount, l as resolveDmAllowState, n as isToolAllowedByPolicies, o as pickSandboxToolPolicy } from "./pi-tools.policy-DlBcQzB9.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-BxOxr-Al.js";
import { n as isDangerousNameMatchingEnabled } from "./dangerous-name-matching-B4c-oh3H.js";
...
import { t as scanDirectoryWithSummary } from "./skill-scanner-BVCwsdIZ.js";
import { t as probeGateway } from "./probe-oK0gM9P8.js";
import { r as resolveNodeCommandAllowlist, t as DEFAULT_DANGEROUS_NODE_COMMANDS } from "./node-command-policy-a0mznNVY.js";
