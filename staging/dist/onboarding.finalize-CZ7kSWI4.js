...
import { v as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-Ckfy1eLE.js";
import { f as restoreTerminalState } from "./subsystem-D5pRlZe-.js";
...
import { b as waitForGatewayReachable, f as openUrl, g as resolveControlUiLinks, i as detectBrowserOpenSupport, m as probeGatewayReachable, o as formatControlUiSshHint } from "./onboard-helpers-KqKFzq9h.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-Bv_R_Omv.js").then((n) => n.r);
