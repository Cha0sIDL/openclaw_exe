...
import "./memory-cli-B80fLS3p.js";
import "./identity-D8H54Ni5.js";
import "./heartbeat-FZaB85hC.js";
import { $a as formatRunLabel, Aa as handleStatusCommand, Bf as formatUsd, Bv as resolveConfigWriteTargetFromPath, Ca as requireCommandFlagEnabled, Cc as listSubagentRunsForController, Da as handleContextCommand, Ea as handleCommandsListCommand, Ey as EmbeddedBlockChunker, Fp as matchPluginCommand, Ga as buildSubagentList, Gv as resolveAcpAgentPolicyError, Hv as resolveAcpSessionIdentifierLinesFromIdentity, Ig as isAbortTrigger, Iv as authorizeConfigWrite, Jf as getTtsProvider, Ka as killAllControlledSubagentRuns, Kf as getLastTtsAttempt, Kv as resolveAcpDispatchPolicyError, Lg as setAbortMemory, Lv as canBypassConfigWritePolicy, Mf as formatContextUsageShort, Nf as formatTokenCount, Np as executePluginCommand, Ny as ensureOpenClawModelsJson, Oa as handleExportSessionCommand, Op as resolveModelWithRegistry, Ou as triggerOpenClawRestart, P as getApiKeyForModel, Qa as formatDurationCompact, R as requireApiKey, Rc as clearSessionQueues, Rv as formatConfigWriteDeniedMessage, Sa as rejectUnauthorizedCommand, Tu as scheduleGatewaySigusr1Restart, Uv as resolveAcpThreadSessionDetailLines, Vd as resolveFastModeState, Vv as resolveAcpSessionCwd, Wv as isAcpEnabledByPolicy, Xa as sendControlledSubagentMessage, Xd as createExecTool, Xf as isTtsEnabled, Yf as isSummarizationEnabled, Za as steerControlledSubagentRun, Zf as isTtsProviderConfigured, _ as stripToolResultDetails, _c as countPendingDescendantRuns, _f as getSession, _p as normalizeSpeechProviderId, a as isEmbeddedPiRunActive, ad as stripToolMessages, ba as buildDisabledCommandReply, co as cleanupFailedAcpSpawn, dp as setTtsProvider, fc as formatAbortReplyText, fh as isTelegramExecApprovalApprover, fl as formatElevatedUnavailableMessage, gf as getFinishedSession, hp as getSpeechProvider, i as getActiveEmbeddedRunSnapshot, ip as resolveTtsPrefsPath, ja as handleWhoamiCommand, ka as handleHelpCommand, l as waitForEmbeddedPiRunEnd, lf as killProcessTree, lp as setTtsEnabled, mc as stopSubagentsForRequester, n as abortEmbeddedPiRun, no as sortSubagentRuns, op as setLastTtsAttempt, p as mapThinkingLevel, pc as resolveSessionEntryForKey, ph as isTelegramExecApprovalClientEnabled, pp as textToSpeech, qa as killControlledSubagentRun, qf as getTtsMaxLength, qv as resolveAcpDispatchPolicyMessage, ro as spawnSubagentDirect, rp as resolveTtsConfig, so as resolveAcpSpawnRuntimePolicyError, sp as setSummarizationEnabled, tp as resolveTtsApiKey, u as compactEmbeddedPiSession, uc as extractBtwQuestion, up as setTtsMaxLength, va as handleModelsCommand, vf as markExited, vl as parseActivationCommand, wa as requireGatewayClientScopeForInternalChannel, xa as rejectNonOwnerCommand, zf as formatTokenCount$1 } from "./pi-embedded-D3aYWCrT.js";
...
import { P as resolveSandboxRuntimeStatus } from "./sandbox-Dy3vKrxx.js";
...
import { t as diag } from "./diagnostic-DNoCLiOo.js";
...
import { c as resolveSessionAuthProfileOverride } from "./level-overrides-pDiOPsgd.js";
...
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-CnIuFJqz.js";
...
import { a as shouldPersistAbortCutoff, i as resolveAbortCutoffFromContext, t as applyAbortCutoffToSessionEntry } from "./abort-cutoff-qV9mvk8L.js";
...
import { i as unsetConfiguredMcpServer, r as setConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-egoiCJ68.js";
import { n as createPluginRuntime } from "./runtime-DezT4Odl.js";
import "./audit-BjqiJuwq.js";
import "./runtime-api-BOypaI63.js";
import "./route-resolution-B74zV6JU.js";
import "./thread-bindings.messages-CdC3sPa3.js";
import "./provider-D_5V0Hvn.js";
import "./timeouts-DZiS4OzV.js";
import "./message-handler-dJaLDPdY.js";
import "./thread-bindings-CUDrQ4Zb.js";
import "./ui-xOkmIC1z.js";
import "./resolve-users-BRdi_lwy.js";
import "./resolve-channels-BEXg0v_Y.js";
import "./timeouts-BW5SSenu.js";
import "./discord-BYsj7jeZ.js";
import "./imessage-D_Xodq5f.js";
...
import { t as formatAcpRuntimeErrorText } from "./error-text-D1KCE64S.js";
import { t as parseConfigValue } from "./config-value-CsISx7wE.js";
import "./install-source-utils-DHaEF4l2.js";
import { a as buildPreferredClawHubSpec, c as decidePreferredClawHubFallback, m as buildNpmInstallRecordFields, n as persistPluginInstall, p as resolveFileNpmSpecToLocalPath, s as createPluginInstallLogger } from "./plugins-install-persist-C8_N2PXK.js";
import { c as parseClawHubPluginSpec } from "./clawhub-DvtcUdXE.js";
import { a as installPluginFromNpmSpec, o as installPluginFromPath } from "./installs-CDt0equv.js";
import { r as installPluginFromClawHub } from "./clawhub-Dsn2Cy0I.js";
import { a as buildPluginStatusReport, i as buildPluginInspectReport, o as formatPluginCompatibilityNotice, t as buildAllPluginInspectReports } from "./status-BgQxL4xd.js";
import { n as loadCostUsageSummary, r as loadSessionCostSummary } from "./session-cost-usage-BvXVbzLr.js";
