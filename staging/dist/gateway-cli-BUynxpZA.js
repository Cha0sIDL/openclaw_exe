...
import { $ as createReplyDispatcher, $t as resolveSessionAuthProfileOverride, A as createOutboundSendDeps, An as isSystemEventContextChanged, B as buildHistoryContextFromEntries, Bn as resolveAgentSessionDirs, Bt as normalizeRequiredName, C as computeBackoff, Cr as resetAllLanes, Ct as runWithModelFallback, Dr as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, Dt as formatRestartSentinelMessage, E as agentCommand, Er as CommandLane, Et as formatDoctorNonInteractiveHint, Fr as onAgentEvent, Ft as inferLegacyName, Gn as extractFileContentFromSource, Hn as DEFAULT_INPUT_IMAGE_MIMES, Ht as buildDeliveryFromLegacyPayload, Ir as registerAgentRunContext, It as normalizeOptionalAgentId, Jn as resolveInputFileLimits, Jt as detectSuspiciousPatterns, Kn as extractImageContentFromSource, Lt as normalizeOptionalSessionKey, M as createOutboundSendDeps$1, Mr as clearAgentRunContext, Mt as normalizeHttpWebhookUrl, N as resolveAgentAvatar, Nn as requestHeartbeatNow, Nr as emitAgentEvent, Nt as normalizeCronJobCreate, O as resolveAgentDeliveryPlan, Pr as getAgentRunContext, Pt as normalizeCronJobPatch, Q as dispatchInboundMessage, Qt as persistBrowserProxyFiles, Rn as ACP_SESSION_IDENTITY_RENDERER_VERSION, Rt as normalizeOptionalText, S as requestBodyErrorToText, Sr as markGatewayDraining, Tr as waitForActiveTasks, Tt as consumeRestartSentinel, Un as DEFAULT_INPUT_MAX_REDIRECTS, Ut as hasLegacyDeliveryHints, Vn as DEFAULT_INPUT_IMAGE_MAX_BYTES, Vt as migrateLegacyCronPayload, Wn as DEFAULT_INPUT_TIMEOUT_MS, Wt as stripLegacyDeliveryFields, Xn as normalizeSendPolicy, Xt as isExternalHookSession, Yn as resolveAgentTimeoutMs, Yt as getHookType, Zn as resolveSendPolicy, Zt as applyBrowserProxyPaths, _ as loadOpenClawPlugins, _n as normalizeGroupActivation, _r as OPENAI_TTS_MODELS, _t as resolveOutboundTarget, a as runSubagentAnnounceFlow, an as parseVerboseOverride, ar as clearBootstrapSnapshot, at as resolveCronStyleNow, b as handleSlackHttpRequest, c as abortEmbeddedPiRun, cn as deferGatewayRestartUntilIdle, cr as isTtsProviderConfigured, ct as runCliAgent, d as applyToolPolicyPipeline, dn as markGatewaySigusr1RestartHandled, dr as resolveTtsConfig, dt as resolveAnnounceTargetFromKey, er as isAbortRequestText, et as getTotalPendingReplies, f as buildDefaultToolPolicyPipelineSteps, fn as scheduleGatewaySigusr1Restart, fr as resolveTtsPrefsPath, gn as unbindThreadBindingsBySessionKey, gr as textToSpeech, h as resolvePluginTools, hn as triggerOpenClawRestart, hr as setTtsProvider, in as applyVerboseOverride, ir as resolveUserTimezone, j as createDefaultDeps, jr as stripHeartbeatToken, jt as writeRestartSentinel, k as resolveAgentOutboundTarget, kn as enqueueSystemEvent, kt as summarizeRestartSentinel, l as getActiveEmbeddedRunCount, ln as emitGatewayRestart, lr as resolveTtsApiKey, lt as createOpenClawTools, m as getPluginToolMeta, mn as setPreRestartDeferralCheck, mr as setTtsEnabled, mt as resolveOutboundSessionRoute, n as initSubagentRegistry, o as clearSessionQueues, on as buildOutboundSessionContext, or as getTtsProvider, ot as getCliSessionId, pn as setGatewaySigusr1RestartPolicy, pr as resolveTtsProviderOrder, pt as ensureOutboundSessionEntry, qn as normalizeMimeList, qt as buildSafeExternalPrompt, r as listDescendantRunsForRequester, rn as applyModelOverrideToSessionEntry, rt as BARE_SESSION_RESET_PROMPT, s as runEmbeddedPiAgent, sn as consumeGatewaySigusr1RestartAuthorization, sr as isTtsEnabled, st as setCliSessionId, t as countActiveDescendantRuns, tr as stopSubagentsForRequester, u as waitForEmbeddedPiRunEnd, un as isGatewaySigusr1RestartExternallyAllowed, ur as resolveTtsAutoMode, ut as readLatestAssistantReply, vr as OPENAI_TTS_VOICES, vt as resolveSessionDeliveryTarget, w as sleepWithAbort, wn as formatZonedTimestamp, wr as setCommandLaneConcurrency, x as readJsonBodyWithLimit, xr as getTotalQueueSize, xt as resetDirectoryCache, yn as loadProviderUsageSummary, yr as getActiveTaskCount, yt as resolveOutboundChannelPlugin, zn as getAcpSessionManager, zt as normalizePayloadToSystemText } from "./subagent-registry-DH1GfDvx.js";
...
import { f as loadGatewayTlsRuntime$1, l as authorizeOperatorScopesForMethod, n as callGateway, s as ADMIN_SCOPE$3, u as isNodeRoleMethod } from "./call-Dm4EXVBs.js";
...
import { a as getMachineDisplayName, i as startBrowserControlServiceFromConfig, n as createBrowserRouteDispatcher, r as createBrowserControlContext } from "./with-timeout-IkkV3wKu.js";
import { S as getGlobalHookRunner, o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads, w as runGlobalGatewayStopSafely } from "./deliver-Cuxsl1JC.js";
...
import { d as loadCronStore, f as resolveCronStorePath, p as saveCronStore } from "./send-Bvk9H8OY.js";
import { c as detectMime } from "./image-ops-Z3_QkQPj.js";
import "./pi-embedded-helpers-C84l2dzW.js";
import { C as resolveToolProfilePolicy, _ as collectExplicitAllowlist, y as mergeAlsoAllowPolicy } from "./sandbox-BD312APH.js";
...
import { c as ensureGatewayStartupAuth, l as mergeGatewayTailscaleConfig } from "./server-context-BmBGdVF_.js";
...
import { i as writeFileWithinRoot, n as openFileWithinRoot, r as readLocalFileSafely, t as SafeOpenError } from "./fs-safe-BVCJaIU_.js";
...
import { i as resolveMemoryBackendConfig, r as getMemorySearchManager } from "./memory-cli-CH6KGKfv.js";
import { n as resolveMemorySearchConfig } from "./manager-BWJEsXOv.js";
...
import { S as extractTextFromChatContent } from "./image-DIpp4vKi.js";
import "./tool-display-FacPPVzc.js";
import { d as registerUnhandledRejectionHandler } from "./runner-BG5hNrDZ.js";
import { n as loadModelCatalog } from "./model-catalog-S0hBJwbP.js";
import "./fetch-CgA7FwwB.js";
import { a as readChannelAllowFromStoreSync } from "./pairing-store-ChXnjrK0.js";
...
import { i as buildChannelUiCatalog, t as applyPluginAutoEnable } from "./plugin-auto-enable-DkOtHjXS.js";
...
import { n as resolveSystemRunCommand } from "./system-run-command-DfWeMDUu.js";
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy } from "./pi-tools.policy-xE6BwpL1.js";
...
import { C as normalizeControlUiBasePath, S as buildControlUiAvatarUrl, c as handleReset, w as resolveAssistantAvatarUrl, x as CONTROL_UI_AVATAR_PREFIX } from "./onboard-helpers-2LMW-m_L.js";
...
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-bUKZ-GKT.js";
...
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-Dni10KGp.js";
...
import "./lifecycle-core-Bal51EMR.js";
import "./systemd-hints-KijFM7Yo.js";
import { t as parsePort$1 } from "./parse-port-DSCrRotM.js";
import { n as addGatewayServiceCommands } from "./daemon-cli-5Wl2fFNu.js";
...
import { a as isNodeCommandAllowed, n as collectEnabledInsecureOrDangerousFlags, o as resolveNodeCommandAllowlist, s as probeGateway } from "./audit-B-u3aM2r.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-COWPH6kR.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-Qr6J133-.js";
import { a as styleHealthChannelLine, c as setHeartbeatsEnabled, l as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines } from "./health-C4LZ2hu8.js";
...
import { i as prepareSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, r as getActiveSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-BTw09pej.js";
import { t as runOnboardingWizard } from "./onboarding-C7xWFTFZ.js";
import { a as sendApnsAlert, c as parseMessageWithAttachments, d as shouldLogWs, f as summarizeAgentEventForWsLog, i as resolveApnsAuthConfigFromEnv, l as formatForLog, n as normalizeApnsEnvironment, o as sendApnsBackgroundWake, p as setGatewayWsLogStyle, s as normalizeRpcAttachmentsToChatAttachments, t as loadApnsRegistration, u as logWs } from "./push-apns-36kC0Hpr.js";
...
import { a as matchSystemRunApprovalBindingV1, i as buildSystemRunApprovalBindingV1, n as resolveSystemRunApprovalRequestContext, o as missingSystemRunApprovalBindingV1, r as resolveSystemRunApprovalRuntimeContext, s as toSystemRunApprovalMismatchError } from "./system-run-approval-context-DzZEg4c0.js";
import { t as installSkill } from "./skills-install-D1iomS_H.js";
import { t as runGatewayUpdate } from "./update-runner-Cgq__mLL.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-BrDrWj0y.js");
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-BsVoGTJr.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		...
		const { deliverOutboundPayloads } = await import("./deliver-Cuxsl1JC.js").then((n) => n.n);
