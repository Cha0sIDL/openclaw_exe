...
import { a as clearExpiredCooldowns, f as resolveProfilesUnavailableReason, s as isProfileInCooldown } from "./auth-profiles-CERaUUqX.js";
...
import { $r as ChannelSelectMenu, Ar as TextDisplay, Br as ReadyListener, C_ as addAllowlistUserEntriesFromConfigEntry, Cg as resolveNativeCommandSessionTargets, D_ as patchAllowlistUsersInConfigEntries, Fp as matchPluginCommand, Fr as InteractionCreateListener, Gr as Client, Gy as normalizeDiscordToken, Hr as VoiceServerUpdateListener, Hy as resolveDiscordAccount, Ir as MessageCreateListener, Jr as StringSelectMenu, Kr as RateLimitError, Lr as MessageReactionAddListener, Mr as Row, Np as executePluginCommand, Nr as Modal, O_ as summarizeMapping, Or as chunkDiscordTextWithMode, Pr as GuildDeleteListener, Qh as wrapFetchWithAbortSignal, Qr as Command, Rr as MessageReactionRemoveListener, T_ as canonicalizeAllowlistWithResolvedIds, Tr as createDiscordClient, Ur as VoiceStateUpdateListener, Vg as resolveEnvelopeFormatOptions, Vp as getPluginCommandSpecs, Vr as ThreadUpdateListener, Wr as ListenerEvent, Wy as resolveDiscordMaxLinesPerMessage, Xr as MentionableSelectMenu, Xt as unregisterGateway, Yr as RoleSelectMenu, Yt as registerGateway, Zr as CommandWithSubcommands, _r as formatDiscordReactionEmoji, ai as GatewayIntentBits, ar as isDiscordGroupAllowedByPolicy, cc as dispatchReplyWithBufferedBlockDispatcher, cg as getExecApprovalApproverDmNoticeText, ci as ApplicationCommandOptionType, cn as parseDiscordComponentCustomId, cr as resolveDiscordAllowListMatch, di as Routes, dn as parseDiscordModalCustomIdForCarbon, dr as resolveDiscordMemberAccessState, ei as Button, er as stripUndefinedFields, fr as resolveDiscordOwnerAccess, ga as buildModelsProviderData, gr as shouldEmitDiscordReactionNotification, hn as resolveDiscordModalEntry, hr as resolveGroupDmAllow, ii as GatewayCloseCodes$1, jr as Container, kr as Separator, lc as dispatchReplyWithDispatcher, li as ButtonStyle, ln as parseDiscordComponentCustomIdForCarbon, lr as resolveDiscordChannelConfigWithFallback, mi as setPresence, mn as resolveDiscordComponentEntry, ni as serializePayload, nn as editDiscordComponentMessage, oi as GatewayOpcodes$1, on as createDiscordFormModal, or as normalizeDiscordAllowList, qr as UserSelectMenu, ri as ChannelType, sc as createReplyReferencePlanner, sn as formatDiscordComponentEventText, sr as normalizeDiscordSlug, ti as Plugin, ug as resolveExecApprovalCommandDisplay, ui as ChannelType$1, un as parseDiscordModalCustomId, ur as resolveDiscordGuildEntry, vr as formatDiscordUserTag, w_ as buildAllowlistResolutionSummary, wt as dispatchPluginInteractiveHandler, xn as formatMention, zg as formatInboundEnvelope, zr as PresenceUpdateListener } from "./pi-embedded-D3aYWCrT.js";
...
import { o as resolveStoredModelOverride } from "./level-overrides-pDiOPsgd.js";
...
import { t as require_src } from "./src-BtOJllZl.js";
import { o as getAgentScopedMediaLocalRoots, t as loadWebMedia } from "./web-media-DiWkPbmA.js";
import { n as createConnectedChannelStatusPatch, t as createOperatorApprovalsGatewayClient } from "./gateway-runtime-B5M5_sR0.js";
import { a as createArmableStallWatchdog } from "./channel-lifecycle-Bzwr_G0Y.js";
import { S as resolveDiscordChannelInfo, a as handleDiscordDmCommandDecision, f as deliverDiscordReply, g as resolveDiscordSenderIdentity, i as resolveDiscordEffectiveRoute, m as buildGuildLabel, n as resolveDiscordBoundConversationRoute, o as resolveDiscordDmCommandAccess, p as buildDirectLabel, s as sendTyping, u as resolveDiscordThreadParentInfo, v as buildDiscordGroupSystemPrompt, y as buildDiscordInboundAccessContext } from "./route-resolution-B74zV6JU.js";
import { a as isThreadArchived } from "./thread-bindings.messages-CdC3sPa3.js";
import { a as runDiscordTaskWithTimeout, i as normalizeDiscordListenerTimeoutMs } from "./timeouts-DZiS4OzV.js";
import { n as fetchDiscordApplicationId, t as DiscordUiContainer } from "./ui-xOkmIC1z.js";
...
async function loadDiscordVoiceRuntime() {
	discordVoiceRuntimePromise ??= import("./manager.runtime-BIcmyLny.js");
	return await discordVoiceRuntimePromise;
}
async function loadDiscordProviderSessionRuntime() {
	discordProviderSessionRuntimePromise ??= import("./provider-session.runtime-CWhHaDYx.js");
