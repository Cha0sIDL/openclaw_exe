...
import { A as resolveDefaultAgentWorkspaceDir, M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, P as toAgentModelListLike, a as resolveAgentDir, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, s as resolveAgentExplicitModelPrimary, u as resolveAgentWorkspaceDir } from "./agent-scope-BGsA4zEf.js";
import { x as shortenHomePath } from "./utils-cwpAMi-t.js";
import { A as coerceSecretRef, F as normalizeSecretInputString } from "./registry-p3miLKfM.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-aWyRxikG.js";
import { Nn as formatUsageWindowSummary, Pn as resolveUsageProviderId, Pt as describeFailoverError, Ur as resolveModelWithRegistry, dn as maskApiKey, fn as DEFAULT_OAUTH_WARN_MS, jn as loadProviderUsageSummary, mn as formatRemainingShort, p as runEmbeddedPiAgent, pn as buildAuthHealthSummary } from "./subagent-registry-DHXuwfxh.js";
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-cmEiiwMK.js";
import { t as ensureOpenClawModelsJson } from "./models-config-C701-Zdv.js";
import { n as loadModelCatalog } from "./model-catalog-Dk_yJRXt.js";
import { i as getModelsCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-DCqd4iaR.js";
import { f as openUrl } from "./onboard-helpers-Cl_losjk.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-By2UMb-r.js";
import { r as withProgressTotals } from "./progress-5B42_wGt.js";
...
import { a as formatMs, c as loadValidConfigOrThrow, d as resolveKnownAgentId, f as resolveModelKeysFromEntries, i as ensureFlagCompatibility, l as mergePrimaryFallbackConfig, m as updateConfig, n as applyOpenAICodexModelDefault, o as formatTokenK, p as resolveModelTarget, r as applyDefaultModelPrimaryUpdate, s as isLocalBaseUrl, t as OPENAI_CODEX_DEFAULT_MODEL, u as normalizeAlias } from "./openai-codex-model-default-C0NW6jqJ.js";
import { Ct as writeOAuthCredentials, d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token--6xqQi0a.js";
import { n as logConfigUpdated } from "./logging-BqngIj6t.js";
import { a as loginOpenAICodexOAuth, c as resolvePluginProviders, i as resolveProviderMatch, n as mergeConfigPatch, o as createVpsAwareOAuthHandlers, r as pickAuthMethod, s as isRemoteEnvironment, t as applyDefaultModel } from "./provider-auth-helpers-Casm0iah.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles-tPxLL4Q6.js").then((n) => n.t);
	const cfg = await loadModelsConfig({
