import { f as resolveSessionAgentId, i as resolveAgentConfig } from "./run-with-concurrency-C1raW7MB.js";
...
import { B as resolveAgentIdFromSessionKey, K as normalizeOptionalAccountId, N as buildAgentMainSessionKey, R as normalizeAgentId, T as resolvePathViaExistingAncestorSync, _ as runExec, a as DEFAULT_IDENTITY_FILENAME, b as openBoundaryFile, c as DEFAULT_USER_FILENAME, i as DEFAULT_HEARTBEAT_FILENAME, j as DEFAULT_AGENT_ID, l as ensureAgentWorkspace, n as DEFAULT_AGENT_WORKSPACE_DIR, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_BOOTSTRAP_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME, z as normalizeMainKey } from "./workspace-C-WsJ6YD.js";
import { E as truncateUtf16Safe, h as normalizeE164, y as resolveUserPath } from "./logger-CrRR9XqM.js";
import { K as resolveSecretRefValues, Q as loadConfig, Ut as CHANNEL_IDS, Z as createConfigIO, _t as parseByteSize, dr as isPidAlive, fr as formatCliCommand, gt as parseDurationMs, ht as getBlockedNetworkModeReason, lr as resolveProcessScopedMap, mt as secretRefKey, nt as writeConfigFile, ur as getProcessStartTime, vr as hasConfiguredSecretInput, xr as resolveSecretInputRef } from "./model-selection-BebDf0Oe.js";
import { c as parseBooleanValue } from "./legacy-names-PdEWCM6o.js";
import { d as getChannelDock, o as normalizeThinkLevel, v as normalizeHyphenSlug } from "./thinking-e8AYL_Pc.js";
import { r as normalizeChannelId, x as normalizeChatType } from "./plugins-D8bZQOC6.js";
import { t as generateSecureToken } from "./secure-random-B_aylR4q.js";
import { i as getImageMetadata, m as normalizeMessageChannel, n as buildImageResizeSideGrid, p as listDeliverableMessageChannels, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-bE_0rjXg.js";
import { A as DEFAULT_DOWNLOAD_DIR, B as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, C as ensureChromeExtensionRelayServer, D as resolveCdpReachabilityTimeouts, F as resolveWritablePathWithinRoot, L as normalizeBrowserFormField, M as DEFAULT_UPLOAD_DIR, N as resolveExistingPathsWithinRoot, R as isLoopbackHost, T as CDP_JSON_NEW_TIMEOUT_MS, U as DEFAULT_OPENCLAW_BROWSER_COLOR, V as DEFAULT_AI_SNAPSHOT_MAX_CHARS, W as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, _ as withBrowserNavigationPolicy, a as resolveOpenClawUserDataDir, b as fetchOk, c as resolveBrowserExecutableForPlatform, f as normalizeCdpWsUrl, g as assertBrowserNavigationResultAllowed, h as assertBrowserNavigationAllowed, i as launchOpenClawChrome, j as DEFAULT_TRACE_DIR, l as captureScreenshot, m as InvalidBrowserNavigationUrlError, n as isChromeCdpReady, o as stopOpenClawChrome, p as snapshotAria, r as isChromeReachable, u as createTargetViaCdp, v as appendCdpPath, w as stopChromeExtensionRelayServer, y as fetchJson } from "./chrome-BAySnG__.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-OJ4_aEbD.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-CehkTmf1.js";
import { n as extractErrorCode, r as formatErrorMessage } from "./errors-CiwC5WY-.js";
import { n as SsrFBlockedError } from "./proxy-env-CKjRmVoX.js";
import { i as saveMediaBuffer, n as ensureMediaDir } from "./store-Clf0bFAY.js";
...
import { a as resolveSessionTranscriptPathInDir, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-CikpXE25.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-BgGkIBR2.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-C0JUp3Ro.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-pXlp0xU7.js");
	} catch (err) {
...
async function closePlaywrightBrowserConnection() {
	try {
		await (await import("./pw-ai-pXlp0xU7.js")).closePlaywrightBrowserConnection();
	} catch {}
}
