...
import { b as waitForGatewayReachable, f as openUrl, g as resolveControlUiLinks, i as detectBrowserOpenSupport, m as probeGatewayReachable, o as formatControlUiSshHint } from "./onboard-helpers-D_Lk_Qaz.js";
...
import { r as isSystemdUserServiceAvailable } from "./systemd-jZCpOsFq.js";
...
import { t as runTui } from "./tui-DPLRuhQj.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-B52UzF6w.js").then((n) => n.r);
