...
import { B as loadConfig, Dr as resolveConfiguredModelRef, Ft as isPathWithinRoot, Li as DEFAULT_MODEL, Lt as isWorkspaceRelativeAvatarPath, Mt as isAvatarDataUrl, Nt as isAvatarHttpUrl, Or as resolveDefaultModelForAgent, Ri as DEFAULT_PROVIDER, cr as resolveOpenClawAgentDir, jt as AVATAR_MAX_BYTES, vr as inferUniqueProviderFromConfiguredModels, wr as parseModelRef, zt as resolveAvatarMime } from "./auth-profiles-Ok_29lfs.js";
...
import { a as openBoundaryFileSync } from "./openclaw-root-BD5PlMF6.js";
import { $ as resolveMainSessionKey, J as resolveFreshSessionTotalTokens, M as readSessionTitleFieldsFromTranscript, X as canonicalizeMainSessionAlias, Z as resolveAgentMainSessionKey, ot as buildGroupDisplayName, s as loadSessionStore, w as normalizeSessionDeliveryFields } from "./sessions-CkpVe03D.js";
...
function ensureContextWindowCacheLoaded() {
	...
	loadPromise = (async () => {
		...
		try {
			const { discoverAuthStorage, discoverModels } = await import("./pi-model-discovery-v4IEHC8Z.js").then((n) => n.r);
