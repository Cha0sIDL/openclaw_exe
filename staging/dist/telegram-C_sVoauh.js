...
import { $m as parseTelegramReplyToMessageId, C as monitorTelegramProvider, E as buildTelegramExecApprovalButtons, Eh as listTelegramAccountIds, Ev as createAllowlistProviderRouteAllowlistWarningCollector, Kp as collectTelegramStatusIssues, M_ as defineChannelPluginEntry, S as probeTelegram, Yc as parseTelegramTopicConversation, _h as listTelegramDirectoryGroupsFromConfig, eh as parseTelegramThreadId, hh as parseTelegramTarget, j_ as createChatChannelPlugin, kh as resolveTelegramAccount, lh as resolveTelegramGroupRequireMention, mh as resolveTelegramExecApprovalTarget, nh as normalizeTelegramMessagingTarget, og as buildExecApprovalPendingReplyPayload, ph as isTelegramExecApprovalClientEnabled, pm as sendTypingTelegram, th as looksLikeTelegramTargetId, tm as sendTelegramPayloadMessages, ug as resolveExecApprovalCommandDisplay, uh as resolveTelegramGroupToolPolicy, vh as listTelegramDirectoryPeersFromConfig, yh as buildTelegramGroupPeerId } from "./pi-embedded-D3aYWCrT.js";
...
import { n as collectTelegramUnmentionedGroupIds, t as auditTelegramGroupMembership } from "./audit-CChGpjlz.js";
...
import { a as telegramSetupWizard, i as telegramConfigAdapter, n as findTelegramTokenOwnerAccountId, o as telegramSetupAdapter, r as formatDuplicateTelegramTokenReason, t as createTelegramPluginBase } from "./shared-DMRT5TuB.js";
		...
		lifecycle: {
			onAccountConfigChanged: async ({ prevCfg, nextCfg, accountId }) => {
				if (resolveTelegramAccount({
					...
					const { deleteTelegramUpdateOffset } = await import("./update-offset-store-Cj_yenVZ.js");
