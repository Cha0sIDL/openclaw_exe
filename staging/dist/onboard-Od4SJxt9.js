...
import { Sn as resolveDefaultSecretProviderAlias, an as writeConfigFile, tn as readConfigFileSnapshot } from "./model-selection-D6yIS4i6.js";
import { N as isValidEnvSecretRefId } from "./registry-D9k2JaF8.js";
import { t as formatCliCommand } from "./command-format-Gp1OUMPH.js";
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-KqKFzq9h.js";
...
import { t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-EyJkS_xW.js";
import { t as runOnboardingWizard } from "./onboarding-BdbH3aIl.js";
import { n as logConfigUpdated } from "./logging-C9DZ91kl.js";
import { i as normalizeLegacyOnboardAuthChoice, r as isDeprecatedAuthChoice, t as ONBOARD_PROVIDER_AUTH_FLAGS } from "./onboard-provider-auth-flags-DFiEN6_l.js";
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-DWnlWcjI.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-vLAX4wzj.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-DB9c3Es8.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-DOwPWHe7.js").then((n) => n.i);
