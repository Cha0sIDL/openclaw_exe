...
import { Bi as CLAUDE_CLI_PROFILE_ID, Dr as resolveConfiguredModelRef, H as readConfigFileSnapshot, K as writeConfigFile, Li as DEFAULT_MODEL, Ri as DEFAULT_PROVIDER, Vi as CODEX_CLI_PROFILE_ID, _r as getModelRefStatus, ar as updateAuthProfileStoreWithLock, d as resolveApiKeyForProfile, hi as resolveApiKeyForProvider, kr as resolveHooksGmailModel, l as resolveProfileUnusableUntilForDisplay, qn as repairOAuthProfileIdMismatch, tr as ensureAuthProfileStore, ut as secretRefKey, x as resolveSecretRefValues } from "./auth-profiles-Ok_29lfs.js";
import { t as formatCliCommand } from "./command-format-BTnLVWI8.js";
import { a as resolveAgentDir, d as resolveDefaultAgentId, g as DEFAULT_AGENTS_FILENAME, u as resolveAgentWorkspaceDir } from "./agent-scope-Ct4K9XNr.js";
...
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-BD5PlMF6.js";
...
import { Er as resolveAgentSessionDirs, Jt as formatRemainingShort, Kt as DEFAULT_OAUTH_WARN_MS, Mr as resolveBootstrapContextForRun, Sr as buildBootstrapInjectionStats, c as loadOpenClawPlugins, qt as buildAuthHealthSummary, xr as analyzeBootstrapBudget } from "./compact-BjaPuUSI.js";
import { n as listChannelPlugins } from "./plugins-DH0nf2wM.js";
import { B as resolveBootstrapTotalMaxChars, R as resolveBootstrapMaxChars } from "./pi-embedded-helpers-CBRvxz6e.js";
import { E as DEFAULT_SANDBOX_BROWSER_IMAGE, O as DEFAULT_SANDBOX_IMAGE, p as resolveSandboxScope } from "./sandbox-B3ZfWqQX.js";
import { d as resolveGatewayBindHost, i as isLoopbackHost } from "./ws-BzjlD7jY.js";
import { a as resolveGatewayAuth } from "./auth-DPbW35vL.js";
import { n as hasAmbiguousGatewayAuthModeConfig } from "./auth-mode-policy-Drs1pjw-.js";
import { n as inspectPortUsage, o as formatPortDiagnostics } from "./ports-fgKk6ALw.js";
import { $ as resolveMainSessionKey, at as isPrimarySessionTranscriptFileName, it as formatSessionArchiveTimestamp, lt as cleanStaleLockFiles, s as loadSessionStore } from "./sessions-CkpVe03D.js";
import { c as resolveStorePath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveSessionTranscriptsDirForAgent } from "./paths-E64m60XY.js";
import { n as loadModelCatalog } from "./model-catalog-H8j7NulN.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-DVkWjKJC.js";
import { l as resolveDmAllowState } from "./pi-tools.policy-BIEFeQWi.js";
import { g as resolveNodeLaunchAgentLabel, m as resolveGatewayWindowsTaskName, p as resolveGatewaySystemdServiceName, u as resolveGatewayLaunchAgentLabel } from "./arg-split-CwmUIqRQ.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-Drc4N8dJ.js";
import { h as randomToken, n as applyWizardMetadata, p as printWizardHeader, s as guardCancel } from "./onboard-helpers-0WTf7rCZ.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-DMpJWKki.js";
import { i as resolveMemoryBackendConfig } from "./memory-cli-f9_hnNTS.js";
import { i as resolveMemorySearchConfig, r as hasConfiguredMemorySecretInput } from "./manager-P7P02HnV.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-CnTOtdpJ.js";
import { t as note$1 } from "./note-C3x48sve.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-g0CpsXvG.js";
import { d as resolveSystemNodeInfo, l as renderSystemNodeWarning, n as gatewayInstallErrorHint, t as buildGatewayInstallPlan } from "./daemon-install-helpers-BrKXBKqG.js";
...
import { l as uninstallLegacySystemdUnits, r as isSystemdUserServiceAvailable } from "./systemd-BHAQEYyJ.js";
import { a as launchAgentPlistExists, i as isLaunchAgentLoaded, o as repairLaunchAgentBootstrap, r as isLaunchAgentListed, s as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-CPBVrfN5.js";
import { i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as formatRuntimeStatus, t as isSystemdUnavailableDetail } from "./systemd-hints-B3ZvMOyU.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-CKfd5Cda.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-CiEvLYG0.js";
import { r as healthCommand } from "./health-CK72o5Yn.js";
import { n as resolveControlUiDistIndexHealth, r as resolveControlUiDistIndexPathForRoot } from "./control-ui-assets-ZAsasQ-Q.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-COAOD3ky.js";
import { t as runGatewayUpdate } from "./update-runner-BIFu6nAp.js";
import { n as logConfigUpdated } from "./logging-CQxJ5H3_.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./oauth-tls-preflight-DSX1a-AH.js";
import { n as detectLegacyStateMigrations, r as runLegacyStateMigrations, t as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-BBFdKnm9.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-B6EU-1W4.js";
import { t as formatHealthCheckFailure } from "./health-format-6vUNbvaQ.js";
import { n as doctorShellCompletion } from "./doctor-completion-DljFurdI.js";
