...
import { r as resolveForwardCompatModel } from "./model-ezP0J990.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-CiFZpX_x.js";
import { Cn as maskApiKey, Sn as resolveUsageProviderId, en as DEFAULT_OAUTH_WARN_MS, nn as formatRemainingShort, s as runEmbeddedPiAgent, tn as buildAuthHealthSummary, wt as describeFailoverError, xn as formatUsageWindowSummary, yn as loadProviderUsageSummary } from "./subagent-registry-DH1GfDvx.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-DWsXK0S0.js";
import { t as ensureOpenClawModelsJson } from "./models-config-W8lviWiq.js";
import { n as loadModelCatalog } from "./model-catalog-S0hBJwbP.js";
import { r as withProgressTotals } from "./progress-bvyZjsUc.js";
import { f as openUrl } from "./onboard-helpers-2LMW-m_L.js";
...
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-CLdCjrPN.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-CYIrd-yn.js";
import { n as logConfigUpdated } from "./logging-Bi2fXy2a.js";
import { a as createVpsAwareOAuthHandlers, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-DISywAI6.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./auth-profiles-CKfLk8eI.js").then((n) => n.D);
	const { ensureAuthProfileStore } = await import("./auth-profiles-CKfLk8eI.js").then((n) => n.t);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-ezP0J990.js").then((n) => n.t);
