...
import { d as defaultRuntime, f as restoreTerminalState } from "./subsystem-B4CcvtwB.js";
import { H as readConfigFileSnapshot, K as writeConfigFile, lt as resolveDefaultSecretProviderAlias } from "./auth-profiles-Ok_29lfs.js";
...
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-0WTf7rCZ.js";
...
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-CbnqDS52.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-BOv5vd9d.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-LQ4_m9Xq.js");
