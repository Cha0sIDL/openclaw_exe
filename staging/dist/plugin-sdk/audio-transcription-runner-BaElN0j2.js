import { O as runExec, U as resolveAgentModelFallbackValues, W as resolveAgentModelPrimaryValue } from "./run-with-concurrency-BmqlpGOz.js";
import { Ar as resolveOpenClawAgentDir, Mn as normalizeProviderId, S as resolveIMessageAttachmentRoots, b as isInboundPathAllowed, er as requireApiKey, n as loadConfig, tr as resolveApiKeyForProvider, x as mergeInboundPathRoots, y as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, zn as normalizeGoogleModelId } from "./config-DHj52j9A.js";
import { L as logVerbose, X as resolvePreferredOpenClawTmpDir, a as createSubsystemLogger, z as shouldLogVerbose } from "./logger-qBtAINSh.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-sbFRyNCD.js";
import { Y as normalizeChatType } from "./plugins-Dpt4e0m6.js";
import { n as fetchWithTimeout } from "./fetch-timeout-poCDPIae.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-B1-FCmEi.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-DDvhDgVm.js";
import { C as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-wPyfG0Yr.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-aQ4DTZ2H.js";
import { n as resolveProxyFetchFromEnv } from "./proxy-fetch-CCmPR5IR.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-TFbqKAGC.js").then((n) => n.r);
