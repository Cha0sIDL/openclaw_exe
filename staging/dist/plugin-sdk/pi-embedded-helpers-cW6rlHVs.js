import { $ as normalizeAgentId, I as resolvePathViaExistingAncestorSync, J as buildAgentMainSessionKey, K as DEFAULT_AGENT_ID, O as runExec, S as ensureAgentWorkspace, _ as DEFAULT_HEARTBEAT_FILENAME, b as DEFAULT_TOOLS_FILENAME, et as normalizeMainKey, f as resolveSessionAgentId, g as DEFAULT_BOOTSTRAP_FILENAME, h as DEFAULT_AGENT_WORKSPACE_DIR, i as resolveAgentConfig, j as openBoundaryFile, m as DEFAULT_AGENTS_FILENAME, st as normalizeOptionalAccountId, tt as resolveAgentIdFromSessionKey, v as DEFAULT_IDENTITY_FILENAME, x as DEFAULT_USER_FILENAME, y as DEFAULT_SOUL_FILENAME } from "./run-with-concurrency-BmqlpGOz.js";
import { a as resolveGatewayPort, d as resolveRequiredHomeDir, n as STATE_DIR } from "./paths-eFexkPEh.js";
import { Fr as isPidAlive, H as parseDurationMs, Ir as formatCliCommand, Jr as resolveSecretInputRef, Nr as resolveProcessScopedMap, Pr as getProcessStartTime, Sr as secretRefKey, U as parseByteSize, Ur as hasConfiguredSecretInput, V as getBlockedNetworkModeReason, _t as CHANNEL_IDS, hr as resolveSecretRefValues, ii as parseBooleanValue, n as loadConfig, o as writeConfigFile, t as createConfigIO } from "./config-DHj52j9A.js";
import { E as resolveUserPath, N as truncateUtf16Safe, S as normalizeE164, a as createSubsystemLogger, c as defaultRuntime } from "./logger-qBtAINSh.js";
import { J as normalizeHyphenSlug, d as getChannelDock, o as normalizeThinkLevel } from "./thinking-2GlTi4JB.js";
import { T as normalizeMessageChannel, i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS, w as listDeliverableMessageChannels } from "./image-ops-sbFRyNCD.js";
import { Y as normalizeChatType, r as normalizeChannelId } from "./plugins-Dpt4e0m6.js";
import { a as resolveSessionTranscriptPathInDir, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-BT9JjwAc.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-DwOFoBTN.js");
	} catch (err) {
...
async function closePlaywrightBrowserConnection() {
	try {
		await (await import("./pw-ai-DwOFoBTN.js")).closePlaywrightBrowserConnection();
	} catch {}
}
