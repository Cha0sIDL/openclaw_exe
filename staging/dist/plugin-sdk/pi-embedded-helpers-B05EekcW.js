...
import { n as loadConfig, o as writeConfigFile, t as createConfigIO, z as getBlockedNetworkModeReason } from "./config-CIl48WCb.js";
...
import { A as acquireSessionWriteLock, H as canonicalizeMainSessionAlias, U as resolveAgentMainSessionKey } from "./sessions-CTjFZbrn.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-BQ6L8PO4.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-BQ6L8PO4.js")).closePlaywrightBrowserConnection();
		} catch {}
