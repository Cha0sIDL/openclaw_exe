import { O as runExec, U as resolveAgentModelFallbackValues, W as resolveAgentModelPrimaryValue } from "./run-with-concurrency-DelsVdbv.js";
import { $n as normalizeProviderId, F as mergeInboundPathRoots, I as resolveIMessageAttachmentRoots, N as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, P as isInboundPathAllowed, Vn as resolveOpenClawAgentDir, i as resolveApiKeyForProvider, or as normalizeGoogleModelId, r as requireApiKey, w as loadConfig } from "./model-auth-B0BF67rM.js";
import { L as logVerbose, O as createSubsystemLogger, Y as resolvePreferredOpenClawTmpDir, z as shouldLogVerbose } from "./logger-sESZPq_e.js";
import { x as normalizeChatType } from "./plugins-BeuoP6Cr.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-Bq48V3Em.js";
import { C as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-DNK4bFhI.js";
import { n as fetchWithTimeout } from "./fetch-timeout-UxR1blUr.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-DOP5benM.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-DgjEbcZx.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-DucBCnCA.js";
import { n as resolveProxyFetchFromEnv } from "./proxy-fetch-D0rPXe4M.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-2yJzwhRA.js").then((n) => n.r);
