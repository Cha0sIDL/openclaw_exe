import { g as getImageMetadata, m as buildImageResizeSideGrid, o as listDeliverableMessageChannels, p as IMAGE_REDUCE_QUALITY_STEPS, s as normalizeMessageChannel, y as resizeToJpeg } from "./message-channel-DKhmLKbn.js";
import { O as createSubsystemLogger, S as truncateUtf16Safe, d as normalizeE164, h as resolveUserPath, j as defaultRuntime } from "./utils-CRWW6TlT.js";
import { a as resolveGatewayPort, d as resolveRequiredHomeDir, n as STATE_DIR } from "./paths-Dmn791zP.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-YfaTOvUj.js";
import { G as buildAgentMainSessionKey, N as resolvePathViaExistingAncestorSync, O as openBoundaryFile, Q as resolveAgentIdFromSessionKey, S as ensureAgentWorkspace, U as DEFAULT_AGENT_ID, X as normalizeAgentId, Z as normalizeMainKey, _ as DEFAULT_HEARTBEAT_FILENAME, b as DEFAULT_TOOLS_FILENAME, f as resolveSessionAgentId, g as DEFAULT_BOOTSTRAP_FILENAME, h as DEFAULT_AGENT_WORKSPACE_DIR, i as resolveAgentConfig, it as normalizeOptionalAccountId, m as DEFAULT_AGENTS_FILENAME, mt as runExec, v as DEFAULT_IDENTITY_FILENAME, x as DEFAULT_USER_FILENAME, y as DEFAULT_SOUL_FILENAME } from "./run-with-concurrency-D7pi7JWf.js";
import { Bn as resolveProcessScopedMap, G as secretRefKey, Hn as isPidAlive, J as parseByteSize, K as getBlockedNetworkModeReason, Nr as parseBooleanValue, Pr as formatCliCommand, St as CHANNEL_IDS, T as loadConfig, Vn as getProcessStartTime, _r as hasConfiguredSecretInput, k as writeConfigFile, q as parseDurationMs, v as resolveSecretRefValues, w as createConfigIO, xr as resolveSecretInputRef } from "./model-auth-CeqyUT3y.js";
import { d as getChannelDock, o as normalizeThinkLevel, v as normalizeHyphenSlug } from "./thinking-DaGh6pJs.js";
import { t as SsrFBlockedError } from "./ssrf-BxOowUJg.js";
import { r as normalizeChannelId, x as normalizeChatType } from "./plugins-PWME-iPc.js";
import { i as writeTextAtomic, r as writeJsonAtomic } from "./json-files-D5o1S-NW.js";
import { a as resolveSessionTranscriptPathInDir, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-CBpVWw1O.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-CcZSZF4e.js";
import { A as DEFAULT_DOWNLOAD_DIR, B as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, C as ensureChromeExtensionRelayServer, D as resolveCdpReachabilityTimeouts, F as resolveWritablePathWithinRoot, L as normalizeBrowserFormField, M as DEFAULT_UPLOAD_DIR, N as resolveExistingPathsWithinRoot, R as isLoopbackHost, T as CDP_JSON_NEW_TIMEOUT_MS, U as DEFAULT_OPENCLAW_BROWSER_COLOR, V as DEFAULT_AI_SNAPSHOT_MAX_CHARS, W as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, _ as withBrowserNavigationPolicy, a as resolveOpenClawUserDataDir, b as fetchOk, c as resolveBrowserExecutableForPlatform, f as normalizeCdpWsUrl, g as assertBrowserNavigationResultAllowed, h as assertBrowserNavigationAllowed, i as launchOpenClawChrome, j as DEFAULT_TRACE_DIR, l as captureScreenshot, m as InvalidBrowserNavigationUrlError, n as isChromeCdpReady, o as stopOpenClawChrome, p as snapshotAria, r as isChromeReachable, u as createTargetViaCdp, v as appendCdpPath, w as stopChromeExtensionRelayServer, y as fetchJson } from "./chrome-mIZnjOxc.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-AvcMUIbd.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-CTafI77c.js";
import { n as extractErrorCode, r as formatErrorMessage } from "./errors-Y5v4UB27.js";
import { i as saveMediaBuffer, n as ensureMediaDir } from "./store-Bt4ar0TV.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-Y495Ugjn.js");
	} catch (err) {
...
async function closePlaywrightBrowserConnection() {
	try {
		await (await import("./pw-ai-Y495Ugjn.js")).closePlaywrightBrowserConnection();
	} catch {}
}
