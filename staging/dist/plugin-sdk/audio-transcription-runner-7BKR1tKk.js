import { O as runExec, U as resolveAgentModelFallbackValues, W as resolveAgentModelPrimaryValue } from "./run-with-concurrency-C7qlYTKU.js";
import { F as isInboundPathAllowed, I as mergeInboundPathRoots, L as resolveIMessageAttachmentRoots, P as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, T as loadConfig, Wn as resolveOpenClawAgentDir, i as resolveApiKeyForProvider, lr as normalizeGoogleModelId, nr as normalizeProviderId, r as requireApiKey } from "./model-auth-ritcJmNz.js";
import { L as logVerbose, O as createSubsystemLogger, Y as resolvePreferredOpenClawTmpDir, z as shouldLogVerbose } from "./logger-COSQR8wc.js";
import { n as fetchWithTimeout } from "./fetch-timeout-D2j7yeE1.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-B-tnCoYM.js";
import { C as normalizeChatType } from "./plugins-DoPATSbd.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-BoVjuw9G.js";
import { C as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-rL4u7pz0.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-aP-GGDL0.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-CCsC-Hbu.js";
import { n as resolveProxyFetchFromEnv } from "./proxy-fetch-BlvHuG8G.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-CkW_d9jY.js").then((n) => n.r);
