import { $ as normalizeAgentId, I as resolvePathViaExistingAncestorSync, J as buildAgentMainSessionKey, K as DEFAULT_AGENT_ID, O as runExec, S as ensureAgentWorkspace, _ as DEFAULT_HEARTBEAT_FILENAME, b as DEFAULT_TOOLS_FILENAME, et as normalizeMainKey, f as resolveSessionAgentId, g as DEFAULT_BOOTSTRAP_FILENAME, h as DEFAULT_AGENT_WORKSPACE_DIR, i as resolveAgentConfig, j as openBoundaryFile, m as DEFAULT_AGENTS_FILENAME, st as normalizeOptionalAccountId, tt as resolveAgentIdFromSessionKey, v as DEFAULT_IDENTITY_FILENAME, x as DEFAULT_USER_FILENAME, y as DEFAULT_SOUL_FILENAME } from "./run-with-concurrency-DelsVdbv.js";
import { C as createConfigIO, Cr as resolveSecretInputRef, Fr as parseBooleanValue, Gn as isPidAlive, Ir as formatCliCommand, J as secretRefKey, O as writeConfigFile, Tt as CHANNEL_IDS, Un as resolveProcessScopedMap, Wn as getProcessStartTime, X as parseDurationMs, Y as getBlockedNetworkModeReason, Z as parseByteSize, br as hasConfiguredSecretInput, v as resolveSecretRefValues, w as loadConfig } from "./model-auth-B0BF67rM.js";
import { E as truncateUtf16Safe, O as createSubsystemLogger, h as normalizeE164, j as defaultRuntime, y as resolveUserPath } from "./logger-sESZPq_e.js";
import { a as resolveGatewayPort, d as resolveRequiredHomeDir, n as STATE_DIR } from "./paths-CtOdJffQ.js";
import { d as getChannelDock, o as normalizeThinkLevel, v as normalizeHyphenSlug } from "./thinking-BzO_Om-G.js";
import { r as normalizeChannelId, x as normalizeChatType } from "./plugins-BeuoP6Cr.js";
import { i as writeTextAtomic, r as writeJsonAtomic } from "./json-files-NtjFUSGE.js";
import { T as normalizeMessageChannel, i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS, w as listDeliverableMessageChannels } from "./image-ops-Bq48V3Em.js";
import { a as resolveSessionTranscriptPathInDir, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-D2cK_vav.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-CuLcdAb2.js";
import { A as DEFAULT_DOWNLOAD_DIR, B as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, C as ensureChromeExtensionRelayServer, D as resolveCdpReachabilityTimeouts, F as resolveWritablePathWithinRoot, L as normalizeBrowserFormField, M as DEFAULT_UPLOAD_DIR, N as resolveExistingPathsWithinRoot, R as isLoopbackHost, T as CDP_JSON_NEW_TIMEOUT_MS, U as DEFAULT_OPENCLAW_BROWSER_COLOR, V as DEFAULT_AI_SNAPSHOT_MAX_CHARS, W as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, _ as withBrowserNavigationPolicy, a as resolveOpenClawUserDataDir, b as fetchOk, c as resolveBrowserExecutableForPlatform, f as normalizeCdpWsUrl, g as assertBrowserNavigationResultAllowed, h as assertBrowserNavigationAllowed, i as launchOpenClawChrome, j as DEFAULT_TRACE_DIR, l as captureScreenshot, m as InvalidBrowserNavigationUrlError, n as isChromeCdpReady, o as stopOpenClawChrome, p as snapshotAria, r as isChromeReachable, u as createTargetViaCdp, v as appendCdpPath, w as stopChromeExtensionRelayServer, y as fetchJson } from "./chrome-DmMVQQmb.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-BGL_A7xA.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-PjG_aFQa.js";
import { n as extractErrorCode, r as formatErrorMessage } from "./errors-DbVn_y4L.js";
import { n as SsrFBlockedError } from "./proxy-env-cH-BXrrY.js";
import { i as saveMediaBuffer, n as ensureMediaDir } from "./store-CjooHtM1.js";
...
import { t as sanitizeContentBlocksImages } from "./tool-images-CbTGSHz3.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-D3wAZe3c.js");
	} catch (err) {
...
async function closePlaywrightBrowserConnection() {
	try {
		await (await import("./pw-ai-D3wAZe3c.js")).closePlaywrightBrowserConnection();
	} catch {}
}
