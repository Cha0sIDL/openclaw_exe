import { E as kindFromMime, S as getFileExtension, b as detectMime, w as isAudioFileName } from "./message-channel-DKhmLKbn.js";
import { L as logVerbose, O as createSubsystemLogger, Y as resolvePreferredOpenClawTmpDir, z as shouldLogVerbose } from "./utils-CRWW6TlT.js";
import { B as resolveAgentModelFallbackValues, V as resolveAgentModelPrimaryValue, mt as runExec } from "./run-with-concurrency-D7pi7JWf.js";
import { F as isInboundPathAllowed, I as mergeInboundPathRoots, L as resolveIMessageAttachmentRoots, P as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, Rn as resolveOpenClawAgentDir, T as loadConfig, Xn as normalizeProviderId, i as resolveApiKeyForProvider, r as requireApiKey, rr as normalizeGoogleModelId } from "./model-auth-CeqyUT3y.js";
import { n as fetchWithTimeout } from "./fetch-timeout-csbOmT9G.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-CQPlORUu.js";
import { x as normalizeChatType } from "./plugins-PWME-iPc.js";
import { C as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-D0g3r_0E.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-BuvWhY3o.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-CQmtV-Dx.js";
import { n as resolveProxyFetchFromEnv } from "./proxy-fetch-CH_RVIlN.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-Bynu5NdR.js").then((n) => n.r);
