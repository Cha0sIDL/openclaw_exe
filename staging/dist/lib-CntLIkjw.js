...
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-ClcN1S7O.js";
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-QzA-nNqM.js";
import { l as toRatio, n as decodeString } from "./Util-CZU5auu2.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-7sy6tUGD.js";
import { t as APEv2Parser } from "./APEv2Parser-DNM5TcnU.js";
import { r as hasID3v1Header } from "./ID3v1Parser-swDu0E6r.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-C_VtEfDv.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-CFR_ZPrA.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-DoVkw9lg.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-kQ6kGALD.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-DGofRNqv.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-BiaScqm9.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-BjWKOz9j.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-DFQ6N5Fb.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-LziW5dUl.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-BIrAZkxa.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-CK3miMTU.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-BJ0Nj7SB.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-BjIGvjs0.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-D_ENNs5N.js")).WaveParser;
	}
};
//#endregion
