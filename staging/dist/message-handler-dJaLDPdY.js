...
import { $g as createReplyDispatcherWithTyping, Ag as shouldDebounceTextInbound, Ey as EmbeddedBlockChunker, Ht as normalizeDiscordOutboundTarget, Jg as dispatchInboundMessage, Og as resolveMentionGatingWithBypass, Or as chunkDiscordTextWithMode, Qt as reactMessageDiscord, Vg as resolveEnvelopeFormatOptions, Wy as resolveDiscordMaxLinesPerMessage, _n as sendPollDiscord, ar as isDiscordGroupAllowedByPolicy, bn as sendWebhookMessageDiscord, br as resolveTimestampMs, di as Routes, dr as resolveDiscordMemberAccessState, en as removeReactionDiscord, fr as resolveDiscordOwnerAccess, gg as recordChannelActivity, gn as sendMessageDiscord, hr as resolveGroupDmAllow, in as sendDiscordComponentMessage, jg as hasControlCommand, kg as createChannelInboundDebouncer, lr as resolveDiscordChannelConfigWithFallback, mr as resolveDiscordShouldRequireMention, pn as buildDiscordInteractiveComponents, ri as ChannelType, si as MessageType, sr as normalizeDiscordSlug, ur as resolveDiscordGuildEntry, vr as formatDiscordUserTag, wn as editMessageDiscord, yr as resolveDiscordSystemLocation, zg as formatInboundEnvelope, zt as fetchPluralKitMessageInfo } from "./pi-embedded-D3aYWCrT.js";
...
async function resolveDiscordPreflightAudioMentionContext(params) {
	...
	if (needsPreflightTranscription) {
		...
		try {
			const { transcribeFirstAudio } = await import("./preflight-audio.runtime-CLZOtls_.js");
			if (params.abortSignal?.aborted) return {
				hasAudioAttachment,
				hasTypedText
			};
