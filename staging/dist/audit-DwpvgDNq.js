...
import { et as resolveBrowserControlAuth, f as redactCdpUrl } from "./routes-BbrNKa8i.js";
import { i as loadExecApprovals } from "./exec-approvals-CVzy3Vfp.js";
import { a as listInterpreterLikeSafeBins, r as isInterpreterLikeAllowlistPattern, s as resolveMergedSafeBinProfileFixtures } from "./exec-inline-eval-D-f8HFse.js";
import { n as hasPotentialConfiguredChannels } from "./config-presence-g2roOSEE.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-Ca3BDJpX.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-DLOBN0Ie.js";
...
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-B81fIkOz.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-D2ZhWtUK.js");
	return await auditDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-DXW6wC0U.js");
