...
import { Cn as splitShellArgs, pt as parseDurationMs, z as loadConfig } from "./auth-profiles-tPxLL4Q6.js";
...
import { r as formatErrorMessage } from "./errors-s25Xfb--.js";
import { r as getMemoryCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-DCqd4iaR.js";
import { m as normalizeExtraMemoryPaths, p as listMemoryFiles } from "./query-expansion-BUI_ltuC.js";
...
import { n as withProgress, r as withProgressTotals } from "./progress-5B42_wGt.js";
...
function loadManagerRuntime() {
	managerRuntimePromise ??= import("./manager-runtime-BxlD-Fa1.js");
...
async function getMemorySearchManager(params) {
	...
	if (resolved.backend === "qmd" && resolved.qmd) {
		...
		try {
			const { QmdMemoryManager } = await import("./qmd-manager-Mob5tjCU.js");
