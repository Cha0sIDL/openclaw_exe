...
import { It as formatUsageWindowSummary, Lt as resolveUsageProviderId, Pt as loadProviderUsageSummary, Vr as resolveModelWithRegistry, a as buildAuthHealthSummary, i as DEFAULT_OAUTH_WARN_MS, ln as describeFailoverError, o as formatRemainingShort, r as maskApiKey, w as runEmbeddedPiAgent } from "./reply-JO7s4SRi.js";
import { A as resolveDefaultAgentWorkspaceDir, M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, P as toAgentModelListLike, a as resolveAgentDir, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, s as resolveAgentExplicitModelPrimary, u as resolveAgentWorkspaceDir } from "./agent-scope-BjNYwuUO.js";
...
import { Ct as resolveProfileUnusableUntilForDisplay, Di as resolveAuthStorePathForDisplay, Hi as DEFAULT_MODEL, Ni as resolveAuthProfileDisplayLabel, Nt as resolveSecretRefString, Oi as resolveOpenClawAgentDir, On as parseDurationMs, Ui as DEFAULT_PROVIDER, _i as setAuthProfileOrder, _t as resolveAuthProfileOrder, at as resolveEnvApiKey, c as modelKey, d as normalizeProviderId, en as loadConfig, f as parseModelRef, g as resolveDefaultModelForAgent, gt as resolveAuthProfileEligibility, h as resolveConfiguredModelRef, hi as listProfilesForProvider, i as findNormalizedProviderValue, it as resolveAwsSdkEnvVarName, r as buildModelAliasIndex, rt as resolveApiKeyForProvider, si as getShellEnvAppliedKeys, tt as getCustomProviderApiKey, ui as shouldEnableShellEnvFallback, v as resolveModelRefFromString, vi as upsertAuthProfile, xi as ensureAuthProfileStore } from "./model-selection-Ct4JRMnm.js";
...
import { t as ensureOpenClawModelsJson } from "./models-config-BYKeUs9Z.js";
...
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-COpaT9Gf.js";
...
import { i as getModelsCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-CgGJf1hR.js";
import "./session-cost-usage-BCVdFsTR.js";
import { f as openUrl } from "./onboard-helpers--etFdTIT.js";
...
import { n as runCommandWithRuntime, t as resolveOptionFromCommand } from "./cli-utils-DRRm3bEM.js";
import "./help-format-BiN-zTsi.js";
import { r as withProgressTotals } from "./progress-CTOv8s8i.js";
...
import { t as createClackPrompter } from "./clack-prompter-B8FSS8De.js";
import "./issue-format-BKmWHlVV.js";
import { t as renderTable } from "./table-CGJWbEiY.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-BdG6BHfo.js";
import { n as redactSecrets } from "./format-BGDJx5D1.js";
import { a as formatMs, c as loadValidConfigOrThrow, d as resolveKnownAgentId, f as resolveModelKeysFromEntries, i as ensureFlagCompatibility, l as mergePrimaryFallbackConfig, m as updateConfig, n as applyOpenAICodexModelDefault, o as formatTokenK, p as resolveModelTarget, r as applyDefaultModelPrimaryUpdate, s as isLocalBaseUrl, t as OPENAI_CODEX_DEFAULT_MODEL, u as normalizeAlias } from "./openai-codex-model-default-D8PMgqaT.js";
import { Ct as writeOAuthCredentials, d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-DHQtgk_V.js";
import { n as logConfigUpdated } from "./logging-V0KcnxRn.js";
import { a as loginOpenAICodexOAuth, c as resolvePluginProviders, i as resolveProviderMatch, l as githubCopilotLoginCommand, n as mergeConfigPatch, o as createVpsAwareOAuthHandlers, r as pickAuthMethod, s as isRemoteEnvironment, t as applyDefaultModel } from "./provider-auth-helpers-C0bBwthi.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./model-selection-Ct4JRMnm.js").then((n) => n.ht);
	const cfg = await loadModelsConfig({
