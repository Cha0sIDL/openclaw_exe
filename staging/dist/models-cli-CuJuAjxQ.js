...
import { Ct as resolveUsageProviderId, St as formatUsageWindowSummary, Xt as describeFailoverError, Zt as maskApiKey, a as DEFAULT_OAUTH_WARN_MS, bt as loadProviderUsageSummary, d as runEmbeddedPiAgent, o as buildAuthHealthSummary, s as formatRemainingShort } from "./reply-Mf1lgoPm.js";
...
import { t as ensureOpenClawModelsJson } from "./models-config-DhSCp0xK.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-CPXfegRB.js";
...
import { r as resolveForwardCompatModel } from "./model-D1IZflyu.js";
...
import { f as openUrl } from "./onboard-helpers-D_Lk_Qaz.js";
...
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-C8h3mbbw.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-Bxz2QwCC.js";
import { n as logConfigUpdated } from "./logging-dewsWJU6.js";
import { a as createVpsAwareOAuthHandlers, c as githubCopilotLoginCommand, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-WePYlnhZ.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./model-selection-UzsaUG4U.js").then((n) => n.Pt);
	const { ensureAuthProfileStore } = await import("./model-selection-UzsaUG4U.js").then((n) => n.ct);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-D1IZflyu.js").then((n) => n.t);
