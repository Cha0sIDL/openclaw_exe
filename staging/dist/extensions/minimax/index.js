...
import { Ph as buildOauthProviderAuthResult } from "../../pi-embedded-D3aYWCrT.js";
import "../../internal-hooks-D4lZfNM5.js";
import "../../multimodal-De3qv_72.js";
import "../../memory-search-DRm4OVlH.js";
import { C as buildMinimaxPortalProvider, w as buildMinimaxProvider } from "../../provider-catalog-7bUKai5_.js";
...
import { o as isMiniMaxModernModelId, r as MINIMAX_TEXT_MODEL_CATALOG, t as MINIMAX_DEFAULT_MODEL_ID } from "../../provider-model-minimax-XdwKeUOE.js";
...
import { a as describeImagesWithModel, i as describeImageWithModel } from "../../media-understanding-Dq7oUfcD.js";
...
import { n as fetchMinimaxUsage } from "../../provider-usage-BQ76VwEQ.js";
import { n as applyOnboardAuthAgentModelsAndProviders, t as applyAgentDefaultModelPrimary } from "../../provider-onboarding-config-DV2e26YS.js";
...
function createOAuthHandler(region) {
	...
	return async (ctx) => {
		...
		try {
			const { loginMiniMaxPortalOAuth } = await import("../../oauth.runtime-Bqog-eN5.js");
