...
import { a as resolveAgentDir, d as resolveDefaultAgentId, g as DEFAULT_AGENTS_FILENAME, u as resolveAgentWorkspaceDir } from "./agent-scope-BGsA4zEf.js";
...
import { L as resolveSecretInputRef, j as hasConfiguredSecretInput } from "./registry-p3miLKfM.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-DZxofag9.js";
import { B as cleanStaleLockFiles, o as loadSessionStore, ot as formatSessionArchiveTimestamp, st as isPrimarySessionTranscriptFileName, tt as resolveMainSessionKey } from "./sessions-0JfTMYG-.js";
import { n as listChannelPlugins } from "./plugins-hyZRvFwO.js";
import { C as loadOpenClawPlugins, Fn as analyzeBootstrapBudget, In as buildBootstrapInjectionStats, Or as resolveBootstrapContextForRun, Sr as resolveAgentSessionDirs, fn as DEFAULT_OAUTH_WARN_MS, mn as formatRemainingShort, pn as buildAuthHealthSummary } from "./subagent-registry-DHXuwfxh.js";
import { c as resolveStorePath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveSessionTranscriptsDirForAgent } from "./paths-cmEiiwMK.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-MMA9uqcd.js";
import { r as isLoopbackHost, u as resolveGatewayBindHost } from "./net-0Fapzizl.js";
import { B as resolveBootstrapTotalMaxChars, R as resolveBootstrapMaxChars } from "./pi-embedded-helpers-BZ9Btdtj.js";
import { D as DEFAULT_SANDBOX_COMMON_IMAGE, E as DEFAULT_SANDBOX_BROWSER_IMAGE, O as DEFAULT_SANDBOX_IMAGE, p as resolveSandboxScope } from "./sandbox-B1Nlj37O.js";
import { a as resolveGatewayAuth } from "./auth-BothAgrh.js";
import { n as hasAmbiguousGatewayAuthModeConfig } from "./auth-mode-policy-Dxm5WN-I.js";
import { n as inspectPortUsage, o as formatPortDiagnostics } from "./ports-GoOZaxy6.js";
import { n as loadModelCatalog } from "./model-catalog-Dk_yJRXt.js";
import { l as resolveDmAllowState } from "./pi-tools.policy-DlBcQzB9.js";
import { f as resolveGatewaySystemdServiceName, h as resolveNodeLaunchAgentLabel, l as resolveGatewayLaunchAgentLabel, p as resolveGatewayWindowsTaskName } from "./constants-DlS2rvx6.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-Gw_7aUfM.js";
import { h as randomToken, n as applyWizardMetadata, p as printWizardHeader, s as guardCancel } from "./onboard-helpers-Cl_losjk.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-By2UMb-r.js";
import { i as resolveMemoryBackendConfig } from "./memory-cli-BnqyPcv5.js";
import { i as resolveMemorySearchConfig, n as DEFAULT_LOCAL_MODEL, r as hasConfiguredMemorySecretInput } from "./manager-Wkc4zq7t.js";
import { t as note$1 } from "./note-DrV9F1n8.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-CknXhw9E.js";
import { d as resolveSystemNodeInfo, l as renderSystemNodeWarning, n as gatewayInstallErrorHint, t as buildGatewayInstallPlan } from "./daemon-install-helpers-gxR8f_p3.js";
...
import { l as uninstallLegacySystemdUnits, r as isSystemdUserServiceAvailable } from "./systemd-BajKVKoa.js";
import { a as launchAgentPlistExists, i as isLaunchAgentLoaded, o as repairLaunchAgentBootstrap, r as isLaunchAgentListed, s as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-Ce1okz8a.js";
import { i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as formatRuntimeStatus, t as isSystemdUnavailableDetail } from "./systemd-hints-HPAJgK9j.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-BeD8xHCT.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-DxXf0kIj.js";
import { r as healthCommand } from "./health-84CrPUUO.js";
import { n as resolveControlUiDistIndexHealth, r as resolveControlUiDistIndexPathForRoot } from "./control-ui-assets-DwBFn-HC.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-B86cc9a5.js";
import { t as runGatewayUpdate } from "./update-runner-D_H4QIAO.js";
import { n as logConfigUpdated } from "./logging-BqngIj6t.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./oauth-tls-preflight-1LXRNWPQ.js";
import { n as detectLegacyStateMigrations, r as runLegacyStateMigrations, t as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-5jtwLJbb.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-DqJcZOwF.js";
import { t as formatHealthCheckFailure } from "./health-format-GTeknL_T.js";
import { n as doctorShellCompletion } from "./doctor-completion-Bwm61_C0.js";
