...
import { r as resolveActionArgs } from "./helpers-B454yiz9.js";
...
const loadConfig = async () => {
	return (await import("./model-selection-D6yIS4i6.js").then((n) => n.Yt)).loadConfig();
};
const entries = [
	{
		name: "acp",
		...
		register: async (program) => {
			(await import("./acp-cli-C4VOpbpp.js")).registerAcpCli(program);
		}
	},
	{
		name: "gateway",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./gateway-cli-DSZ4Rp0H.js")).registerGatewayCli(program);
		}
	},
	{
		name: "daemon",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./daemon-cli-BmO0YlBl.js").then((n) => n.t)).registerDaemonCli(program);
		}
	},
	{
		name: "logs",
		...
		register: async (program) => {
			(await import("./logs-cli-BSh0aBL2.js")).registerLogsCli(program);
		}
	},
	{
		name: "system",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./system-cli-B86FHGkS.js")).registerSystemCli(program);
		}
	},
	{
		name: "models",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./models-cli-C0VcmSn_.js")).registerModelsCli(program);
		}
	},
	{
		name: "approvals",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./exec-approvals-cli-Du320P12.js")).registerExecApprovalsCli(program);
		}
	},
	{
		name: "nodes",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./nodes-cli-DdDPYxMM.js")).registerNodesCli(program);
		}
	},
	{
		name: "devices",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./devices-cli-1QVcqU6R.js")).registerDevicesCli(program);
		}
	},
	{
		name: "node",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./node-cli-RQPSbsWh.js")).registerNodeCli(program);
		}
	},
	{
		name: "sandbox",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./sandbox-cli-4C7xdsCD.js")).registerSandboxCli(program);
		}
	},
	{
		name: "tui",
		...
		hasSubcommands: false,
		register: async (program) => {
			(await import("./tui-cli-DCXXENcY.js")).registerTuiCli(program);
		}
	},
	{
		name: "cron",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./cron-cli-CQuBUM0r.js")).registerCronCli(program);
		}
	},
	{
		name: "dns",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./dns-cli-DbMTpTul.js")).registerDnsCli(program);
		}
	},
	{
		name: "docs",
		...
		hasSubcommands: false,
		register: async (program) => {
			(await import("./docs-cli-AwM5Sc44.js")).registerDocsCli(program);
		}
	},
	{
		name: "hooks",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./hooks-cli-I46AFgb9.js")).registerHooksCli(program);
		}
	},
	{
		name: "webhooks",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./webhooks-cli-Vh9fjFtX.js")).registerWebhooksCli(program);
		}
	},
	{
		name: "qr",
		...
		hasSubcommands: false,
		register: async (program) => {
			(await import("./qr-cli-DytpAgxd.js").then((n) => n.t)).registerQrCli(program);
		}
	},
	{
		name: "clawbot",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./clawbot-cli-E70hf5Hr.js")).registerClawbotCli(program);
		}
	},
	{
		name: "pairing",
		...
		hasSubcommands: true,
		register: async (program) => {
			const { registerPluginCliCommands } = await import("./cli-quDBsMZo.js");
			registerPluginCliCommands(program, await loadConfig());
			(await import("./pairing-cli-mho7grwW.js")).registerPairingCli(program);
		}
	},
	{
		name: "plugins",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./plugins-cli-BS-of7TY.js")).registerPluginsCli(program);
			const { registerPluginCliCommands } = await import("./cli-quDBsMZo.js");
			registerPluginCliCommands(program, await loadConfig());
		}
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./channels-cli-Bdw_9UcZ.js")).registerChannelsCli(program);
		}
	},
	{
		name: "directory",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./directory-cli-DwwTMJjN.js")).registerDirectoryCli(program);
		}
	},
	{
		name: "security",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./security-cli-844R1Aqc.js")).registerSecurityCli(program);
		}
	},
	{
		name: "secrets",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./secrets-cli-XZ-jV8ZW.js")).registerSecretsCli(program);
		}
	},
	{
		name: "skills",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./skills-cli-CqgtD--w.js")).registerSkillsCli(program);
		}
	},
	{
		name: "update",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./update-cli-Y3Xvaoo2.js")).registerUpdateCli(program);
		}
	},
	{
		name: "completion",
		...
		hasSubcommands: false,
		register: async (program) => {
			(await import("./completion-cli-BZYKi6hQ.js").then((n) => n.n)).registerCompletionCli(program);
		}
	}
];
...
const coreEntries = [
	{
		...
		register: async ({ program }) => {
			(await import("./register.setup-CJfyLIxL.js")).registerSetupCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./register.onboard-x1YyJmSX.js")).registerOnboardCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./register.configure-D--vgNJG.js")).registerConfigureCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./config-cli-DfWdBxAv.js")).registerConfigCli(program);
		}
	},
	{
		commands: [
		...
		register: async ({ program }) => {
			(await import("./register.maintenance-DO_d6SJL.js")).registerMaintenanceCommands(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program, ctx }) => {
			(await import("./register.message-Nz--u7Xf.js")).registerMessageCommands(program, ctx);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./memory-cli-DHsLaREm.js").then((n) => n.t)).registerMemoryCli(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program, ctx }) => {
			(await import("./register.agent-sqk-4n5w.js")).registerAgentCommands(program, { agentChannelOptions: ctx.agentChannelOptions });
		}
	},
	{
		commands: [
		...
		register: async ({ program }) => {
			(await import("./register.status-health-sessions-D2QNsSpv.js")).registerStatusHealthSessionsCommands(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./browser-cli-Dclk2fRR.js")).registerBrowserCli(program);
		}
	}
];
