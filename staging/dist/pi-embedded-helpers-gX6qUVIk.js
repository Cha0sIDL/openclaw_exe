import { d as resolveSessionAgentId, r as resolveAgentConfig } from "./agent-scope-k12jKXhS.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-UlykDy1s.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-UlykDy1s.js")).closePlaywrightBrowserConnection();
		} catch {}
