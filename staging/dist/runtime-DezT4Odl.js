...
import { t as registerMemoryCli } from "./memory-cli-B80fLS3p.js";
...
import { $g as createReplyDispatcherWithTyping, $i as pushMessageLine, $s as probeSignal, D as telegramMessageActions, Fc as onAgentEvent, Ng as isControlCommandMessage, Ni as monitorLineProvider, Pg as shouldComputeCommandAuthorized, Pi as buildTemplateMessageFromPayload, Qi as pushLocationMessage, Qm as isVoiceCompatibleAudio, Rg as formatAgentEnvelope, T as setTelegramThreadBindingMaxAgeBySessionKey, Ua as listWebSearchProviders, Vg as resolveEnvelopeFormatOptions, Wa as runWebSearch, Xi as createQuickReplyItems, Zg as withReplyDispatcher, Zi as pushFlexMessage, _u as listRuntimeImageGenerationProviders, aa as normalizeAccountId, cc as dispatchReplyWithBufferedBlockDispatcher, ea as pushMessagesLine, ec as monitorSignalProvider, f_ as createInboundDebouncer, ff as requestHeartbeatNow, gg as recordChannelActivity, gu as generateImage, hg as getChannelActivity, ia as listLineAccountIds, jg as hasControlCommand, jh as resolveTelegramToken, ji as probeLineBot, na as pushTextMessageWithQuickReplies, oa as resolveDefaultLineAccountId, p_ as resolveInboundDebounceMs, ra as sendMessageLine, sa as resolveLineAccount, t_ as dispatchReplyFromConfig, ta as pushTemplateMessage, tc as sendMessageSignal, w as setTelegramThreadBindingIdleTimeoutBySessionKey, yl as signalMessageActions, zg as formatInboundEnvelope } from "./pi-embedded-D3aYWCrT.js";
...
import { P as saveMediaBuffer } from "./routes-BbrNKa8i.js";
...
import { l as fetchRemoteMedia, t as loadWebMedia } from "./web-media-DiWkPbmA.js";
import { n as shouldAckReaction, t as removeAckReactionAfterReply } from "./ack-reactions-DVXLJRuf.js";
import { n as collectTelegramUnmentionedGroupIds } from "./audit-CChGpjlz.js";
...
import { a as setThreadBindingMaxAgeBySessionKey, i as setThreadBindingIdleTimeoutBySessionKey, l as getThreadBindingManager, o as unbindThreadBindingsBySessionKey } from "./thread-bindings-CUDrQ4Zb.js";
import { n as sendMessageIMessage, r as probeIMessage, t as monitorIMessageProvider } from "./imessage-D_Xodq5f.js";
...
const loadEmbeddedPiRuntime = createLazyRuntimeModule(() => import("./runtime-embedded-pi.runtime-DnR6RJ8y.js"));
...
const bindDiscordRuntimeMethod = createLazyRuntimeMethodBinder(createLazyRuntimeSurface(() => import("./runtime-discord-ops.runtime-CKKylq1U.js"), ({ runtimeDiscordOps }) => runtimeDiscordOps));
...
const bindSlackRuntimeMethod = createLazyRuntimeMethodBinder(createLazyRuntimeSurface(() => import("./runtime-slack-ops.runtime-BJWdFD8Q.js"), ({ runtimeSlackOps }) => runtimeSlackOps));
...
const bindTelegramRuntimeMethod = createLazyRuntimeMethodBinder(createLazyRuntimeSurface(() => import("./runtime-telegram-ops.runtime-CuDljYqR.js"), ({ runtimeTelegramOps }) => runtimeTelegramOps));
...
async function loadMemoryToolRuntime() {
	memoryToolRuntimePromise ??= import("./memory-tool.runtime-Dd9VwHuj.js");
...
const loadTtsRuntime = createLazyRuntimeModule(() => import("./runtime-tts.runtime-Co7JL73e.js"));
const loadMediaUnderstandingRuntime = createLazyRuntimeModule(() => import("./runtime-media-understanding.runtime-MKp8vrDZ.js"));
const loadModelAuthRuntime = createLazyRuntimeModule(() => import("./runtime-model-auth.runtime-BYUHwCNJ.js"));
