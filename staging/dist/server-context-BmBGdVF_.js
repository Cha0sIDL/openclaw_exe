...
import { A as createConfigIO, L as writeConfigFile, j as loadConfig } from "./auth-profiles-CKfLk8eI.js";
...
import { c as normalizeBrowserFormField, i as resolveExistingPathsWithinRoot, n as DEFAULT_TRACE_DIR, o as resolveWritablePathWithinRoot, r as DEFAULT_UPLOAD_DIR, t as DEFAULT_DOWNLOAD_DIR } from "./paths-BE9S7VOj.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-BTlrNnMt.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-BTlrNnMt.js")).closePlaywrightBrowserConnection();
		} catch {}
