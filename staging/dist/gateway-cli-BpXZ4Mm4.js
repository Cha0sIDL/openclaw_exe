...
import { a as setConsoleSubsystemFilter, d as defaultRuntime, n as runtimeForLogger, o as setConsoleTimestampPrefix, t as createSubsystemLogger } from "./subsystem-B4CcvtwB.js";
import "./boolean-DTgd5CzD.js";
import { i as logAcceptedEnvOption, r as isTruthyEnvValue } from "./entry.js";
import { An as ensureControlUiAllowedOriginsForNonLoopbackBind, B as loadConfig, Dr as resolveConfiguredModelRef, H as readConfigFileSnapshot, Hn as buildTalkConfigResponse, J as OpenClawSchema, K as writeConfigFile, L as migrateLegacyConfig, Li as DEFAULT_MODEL, Mi as normalizeSecretInput, Mr as resolveSubagentConfiguredModelSelection, Nt as isAvatarHttpUrl, On as applyMergePatch, Or as resolveDefaultModelForAgent, Pr as resolveThinkingDefault, Pt as isAvatarImageDataUrl, Ri as DEFAULT_PROVIDER, Rt as looksLikeAvatarPath, Sr as normalizeModelSelection, Tr as resolveAllowedModelRef, U as readConfigFileSnapshotForWrite, Un as resolveAgentMaxConcurrent, V as parseConfigJson5, W as resolveConfigSnapshotHash, Wn as resolveSubagentMaxConcurrent, _r as getModelRefStatus, fr as isPidAlive, ht as parseByteSize, jt as AVATAR_MAX_BYTES, kn as applyLegacyMigrations, kr as resolveHooksGmailModel, mt as parseDurationMs, pr as buildAllowedModelSet, q as validateConfigObjectWithPlugins, yr as isCliProvider, z as createConfigIO } from "./auth-profiles-Ok_29lfs.js";
import { t as formatCliCommand } from "./command-format-BTnLVWI8.js";
import { A as resolveDefaultAgentWorkspaceDir, C as DEFAULT_SOUL_FILENAME, E as ensureAgentWorkspace, O as isWorkspaceOnboardingCompleted, S as DEFAULT_MEMORY_FILENAME, T as DEFAULT_USER_FILENAME, a as resolveAgentDir, b as DEFAULT_IDENTITY_FILENAME, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, g as DEFAULT_AGENTS_FILENAME, i as resolveAgentConfig, j as resolveWorkspaceTemplateDir, l as resolveAgentSkillsFilter, m as resolveSessionAgentId, n as listAgentEntries, r as listAgentIds, u as resolveAgentWorkspaceDir, v as DEFAULT_BOOTSTRAP_FILENAME, w as DEFAULT_TOOLS_FILENAME, x as DEFAULT_MEMORY_ALT_FILENAME, y as DEFAULT_HEARTBEAT_FILENAME } from "./agent-scope-Ct4K9XNr.js";
...
import { a as openBoundaryFileSync, f as isNotFoundPathError, g as matchesSkillFilter, i as openBoundaryFile, o as openVerifiedFileSync, s as sameFileIdentity, t as resolveOpenClawPackageRoot } from "./openclaw-root-BD5PlMF6.js";
import { i as logWarn, t as logDebug } from "./logger-DK5MgyI_.js";
import { n as runExec, t as runCommandWithTimeout } from "./exec-Ma6oRU03.js";
...
import { n as loadModelCatalog } from "./model-catalog-H8j7NulN.js";
import "./fetch-sqY6FCRx.js";
import { g as registerUnhandledRejectionHandler } from "./audio-transcription-runner-CQ9UFry3.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-DrmhSLIg.js";
import { b as extractTextFromChatContent } from "./image-DiopATC4.js";
...
import { a as ToolInputError } from "./target-errors-SNhw0r88.js";
import { r as isRestartEnabled } from "./commands-BNyCzjzn.js";
import "./commands-registry-Q8iSE9Pt.js";
import { c as hasNonzeroUsage, i as loadSessionUsageTimeSeries, n as loadCostUsageSummary, r as loadSessionCostSummary, s as deriveSessionTotalTokens, t as discoverAllSessions } from "./session-cost-usage-CC6en8Ih.js";
...
import { n as GATEWAY_AUTH_SURFACE_PATHS, p as isKnownSecretTargetId, r as evaluateGatewayAuthSurfaceStates } from "./runtime-config-collectors-C7NEx3Ij.js";
import "./command-secret-targets-Hw0LPI1L.js";
import { C as normalizeControlUiBasePath, S as buildControlUiAvatarUrl, c as handleReset, w as resolveAssistantAvatarUrl, x as CONTROL_UI_AVATAR_PREFIX } from "./onboard-helpers-0WTf7rCZ.js";
import "./prompt-style-DMpJWKki.js";
import "./pairing-labels-DLeO9en5.js";
import { i as resolveMemoryBackendConfig, r as getMemorySearchManager } from "./memory-cli-f9_hnNTS.js";
import { i as resolveMemorySearchConfig } from "./manager-P7P02HnV.js";
import { t as formatDocsLink } from "./links-BhWccyz9.js";
import { n as runCommandWithRuntime } from "./cli-utils-CZIibHLA.js";
import { t as formatHelpExamples } from "./help-format-CMYKW3HF.js";
import { n as withProgress } from "./progress-iK4ygO8h.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-CnTOtdpJ.js";
import { i as onHeartbeatEvent, r as getLastHeartbeatEvent, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-CQmYNM4T.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-DKITKILj.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-Cinpw2xf.js";
import { n as inheritOptionFromParent } from "./command-options-BMU9FBQI.js";
import { t as WizardCancelledError } from "./prompts-CiIZlAKi.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-BCOync6K.js";
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-BfrSJSs2.js";
import { t as isWithinDir } from "./path-safety-C75WXpzD.js";
import "./install-safe-path-D-LDB6ZS.js";
import "./skill-scanner-Cmw7Fh0h.js";
import { n as formatConfigIssueLines } from "./issue-format-BngyB0_B.js";
import { t as buildChannelAccountSnapshot } from "./status-eMsDcc3I.js";
import "./channels-status-issues-g0CpsXvG.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-CHAFsR0u.js";
...
import "./lifecycle-core-Cv8ugcvH.js";
import "./systemd-hints-B3ZvMOyU.js";
import { t as parsePort$1 } from "./parse-port-DRQt1m1H.js";
import { n as addGatewayServiceCommands } from "./daemon-cli-DUmg5V86.js";
import { t as probeGateway } from "./probe-CSOAxNOo.js";
import "./diagnostics-CKfd5Cda.js";
import "./table-DjoRvv-3.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-HDIbM2he.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-BHtZ3oLV.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-BrtKcBjQ.js";
import { t as resolveConfiguredSecretInputString } from "./resolve-configured-secret-input-string-g6Dmh7Eu.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-D4jqyvUz.js";
import { a as styleHealthChannelLine, c as setHeartbeatsEnabled, l as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines, u as isCronSystemEvent } from "./health-CK72o5Yn.js";
import { a as resolveControlUiRootSync, i as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-ZAsasQ-Q.js";
import { m as normalizeUpdateChannel, n as checkUpdateStatus, o as resolveNpmChannelTag, r as compareSemverStrings } from "./channel-account-context-COAOD3ky.js";
import { a as resolveCommandSecretsFromActiveRuntimeSnapshot, i as prepareSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, r as getActiveSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-Ba8ljG2b.js";
import "./onboarding.secret-input-8hI6dJpv.js";
import { t as runOnboardingWizard } from "./onboarding-CqZbYFPH.js";
import { a as sendApnsAlert, c as parseMessageWithAttachments, d as shouldLogWs, f as summarizeAgentEventForWsLog, i as resolveApnsAuthConfigFromEnv, l as formatForLog, n as normalizeApnsEnvironment, o as sendApnsBackgroundWake, p as setGatewayWsLogStyle, s as normalizeRpcAttachmentsToChatAttachments, t as loadApnsRegistration, u as logWs } from "./push-apns-CNZegJvl.js";
import { _ as buildGogWatchStartArgs, g as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, w as resolveGmailHookRuntimeConfig } from "./gmail-setup-utils-BVvPpsvf.js";
import { n as isNodeCommandAllowed, r as resolveNodeCommandAllowlist } from "./node-command-policy-1_dwEWn9.js";
import { n as collectEnabledInsecureOrDangerousFlags } from "./audit-Dqt57Ke3.js";
import "./node-service-CFobV9KM.js";
import "./status.update-Ddqd_bD8.js";
import { t as installSkill } from "./skills-install-cVPElhId.js";
import { t as runGatewayUpdate } from "./update-runner-BIFu6nAp.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-XotjO7AR.js";
import { n as forceFreePortAndWait, r as waitForPortBindable } from "./ports-D-ZqHIyz.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-CVwVAoTT.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-CC6en8Ih.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-CL2AcM03.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-CzFxbZH8.js").then((n) => n.n);
		const { deliverOutboundPayloads } = await import("./deliver-BCYVnhPK.js").then((n) => n.n);
