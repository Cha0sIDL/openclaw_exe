...
import { b as waitForGatewayReachable, d as openUrl, g as resolveControlUiLinks, i as detectBrowserOpenSupport, o as formatControlUiSshHint, p as probeGatewayReachable } from "./onboard-helpers-Cks5EPpw.js";
...
import { Ha as listConfiguredWebSearchProviders } from "./pi-embedded-D3aYWCrT.js";
...
import { t as runTui } from "./tui-BO7vdVC_.js";
...
async function finalizeSetupWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-DOb_vWpZ.js");
	...
	if (webSearchProvider) {
		const { resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-B9hwLfR5.js");
		...
		const { hasExistingKey, hasKeyInEnv } = await import("./onboard-search-B9hwLfR5.js");
