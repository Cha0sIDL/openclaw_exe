...
const loadConfig = async () => {
	return (await import("./model-selection-UzsaUG4U.js").then((n) => n.Pt)).loadConfig();
};
const entries = [
	{
		name: "acp",
		...
		register: async (program) => {
			(await import("./acp-cli-CuRHmfUO.js")).registerAcpCli(program);
		}
	},
	{
		name: "gateway",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./gateway-cli-BWZF_Agw.js")).registerGatewayCli(program);
		}
	},
	{
		name: "daemon",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./daemon-cli-D2zwy_dp.js").then((n) => n.t)).registerDaemonCli(program);
		}
	},
	{
		name: "logs",
		...
		register: async (program) => {
			(await import("./logs-cli-BeluMGI6.js")).registerLogsCli(program);
		}
	},
	{
		name: "system",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./system-cli-CLinxjxO.js")).registerSystemCli(program);
		}
	},
	{
		name: "models",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./models-cli-CuJuAjxQ.js")).registerModelsCli(program);
		}
	},
	{
		name: "approvals",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./exec-approvals-cli-Cf7ZP6Kp.js")).registerExecApprovalsCli(program);
		}
	},
	{
		name: "nodes",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./nodes-cli-CiJ2obrF.js")).registerNodesCli(program);
		}
	},
	{
		name: "devices",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./devices-cli-CfdqGpzu.js")).registerDevicesCli(program);
		}
	},
	{
		name: "node",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./node-cli-Di2aqLaT.js")).registerNodeCli(program);
		}
	},
	{
		name: "sandbox",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./sandbox-cli-1flPKrEp.js")).registerSandboxCli(program);
		}
	},
	{
		name: "tui",
		...
		hasSubcommands: false,
		register: async (program) => {
			(await import("./tui-cli-BAsvSROQ.js")).registerTuiCli(program);
		}
	},
	{
		name: "cron",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./cron-cli-CWncAa1T.js")).registerCronCli(program);
		}
	},
	{
		name: "dns",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./dns-cli-CdGHdBuh.js")).registerDnsCli(program);
		}
	},
	{
		name: "docs",
		...
		hasSubcommands: false,
		register: async (program) => {
			(await import("./docs-cli-TRP0gUs_.js")).registerDocsCli(program);
		}
	},
	{
		name: "hooks",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./hooks-cli-BwlfiO3F.js")).registerHooksCli(program);
		}
	},
	{
		name: "webhooks",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./webhooks-cli-H70OoLjZ.js")).registerWebhooksCli(program);
		}
	},
	{
		name: "qr",
		...
		hasSubcommands: false,
		register: async (program) => {
			(await import("./qr-cli-D2xJtSi-.js").then((n) => n.t)).registerQrCli(program);
		}
	},
	{
		name: "clawbot",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./clawbot-cli-CRBx7FXt.js")).registerClawbotCli(program);
		}
	},
	{
		name: "pairing",
		...
		hasSubcommands: true,
		register: async (program) => {
			const { registerPluginCliCommands } = await import("./cli-D_rgZskJ.js");
			registerPluginCliCommands(program, await loadConfig());
			(await import("./pairing-cli-Bv8mpogx.js")).registerPairingCli(program);
		}
	},
	{
		name: "plugins",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./plugins-cli-mpE2vWO0.js")).registerPluginsCli(program);
			const { registerPluginCliCommands } = await import("./cli-D_rgZskJ.js");
			registerPluginCliCommands(program, await loadConfig());
		}
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./channels-cli-FL26zcVw.js")).registerChannelsCli(program);
		}
	},
	{
		name: "directory",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./directory-cli-oOLxt22J.js")).registerDirectoryCli(program);
		}
	},
	{
		name: "security",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./security-cli-C9H0bVEb.js")).registerSecurityCli(program);
		}
	},
	{
		name: "secrets",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./secrets-cli-BKlq58J8.js")).registerSecretsCli(program);
		}
	},
	{
		name: "skills",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./skills-cli-DmxtKxPZ.js")).registerSkillsCli(program);
		}
	},
	{
		name: "update",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./update-cli-DJoFQibH.js")).registerUpdateCli(program);
		}
	},
	{
		name: "completion",
		...
		hasSubcommands: false,
		register: async (program) => {
			(await import("./completion-cli-B5oAAaC1.js").then((n) => n.n)).registerCompletionCli(program);
		}
	}
];
...
const coreEntries = [
	{
		...
		register: async ({ program }) => {
			(await import("./register.setup-BNKBdQ2u.js")).registerSetupCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./register.onboard-DLam9RAh.js")).registerOnboardCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./register.configure-CJrq5_Vp.js")).registerConfigureCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./config-cli-DshLVGY-.js")).registerConfigCli(program);
		}
	},
	{
		commands: [
		...
		register: async ({ program }) => {
			(await import("./register.maintenance-Bige7I5q.js")).registerMaintenanceCommands(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program, ctx }) => {
			(await import("./register.message-DIZ4pmjo.js")).registerMessageCommands(program, ctx);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./memory-cli-BBC9C0fJ.js").then((n) => n.t)).registerMemoryCli(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program, ctx }) => {
			(await import("./register.agent-zY5pvv9K.js")).registerAgentCommands(program, { agentChannelOptions: ctx.agentChannelOptions });
		}
	},
	{
		commands: [
		...
		register: async ({ program }) => {
			(await import("./register.status-health-sessions-BNfg4N5M.js")).registerStatusHealthSessionsCommands(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./browser-cli-CMvsCzbn.js")).registerBrowserCli(program);
		}
	}
];
