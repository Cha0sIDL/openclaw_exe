...
import { I as createConfigIO, L as loadConfig, Q as getBlockedNetworkModeReason, V as writeConfigFile } from "./model-selection-BX3t4Buk.js";
...
import { r as saveMediaBuffer, t as ensureMediaDir } from "./store-CSf3lMm_.js";
import { H as resolveAgentMainSessionKey, V as canonicalizeMainSessionAlias, q as acquireSessionWriteLock } from "./sessions-CsJaFmV1.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-Caeg2alC.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-JtVX0iCw.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-JtVX0iCw.js")).closePlaywrightBrowserConnection();
		} catch {}
